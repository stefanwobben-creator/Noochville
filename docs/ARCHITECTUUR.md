...
|---|---|
| `ff_beslis` | `cockpit2.py:4904` |
| `ff_cluster` | `cockpit2.py:5032` |
| `ff_promote` | `cockpit2.py:4962` |
| `ff_demote` | `cockpit2.py:4986` |
| `ff_run` | `cockpit2.py:5005` |
| `kb_new` | `cockpit2.py:4284` |
| `kb_intake` | `cockpit2.py:4366` |
| `kb_intake_url` | `cockpit2.py:4383` |
| `kb_stage_edit` | `cockpit2.py:4402` |
| `kb_stage_accept` | `cockpit2.py:4414` |
| `kb_stage_delete` | `cockpit2.py:4433` |
| `kb_stage_merge` | `cockpit2.py:4439` |
| `kb_stage_commit` | `cockpit2.py:4450` |
| `kb_stage_discard` | `cockpit2.py:4470` |
| `kb_atoom_subject` | `cockpit2.py:4708` |
| `kb_atoom_purge` | `cockpit2.py:4692` |
| `tag_voorstel_besluit` | `cockpit2.py:4546` |
| `tag_onderhoud_run` | `cockpit2.py:4679` |
| `copy_stack_inclusie` | `cockpit2.py:4661` |
| `verzoek_besluit` | `cockpit2.py:4565` |
| `kb_blacklist_leeg` | `cockpit2.py:4701` |
| `kb_atoom_edit` | `cockpit2.py:4476` |
| `kb_atoom_related` | `cockpit2.py:4483` |
| `kb_atoom_reference` | `cockpit2.py:4528` |
| `kb_insight_link` | `cockpit2.py:4495` |
| `kb_insight_unlink` | `cockpit2.py:4502` |
| `kb_meta_start` | `cockpit2.py:4508` |
| `kb_atoom_merge` | `cockpit2.py:4719` |
| `kb_atoom_archive` | `cockpit2.py:4740` |
| `kb_atoom_unarchive` | `cockpit2.py:4749` |
| `kb_atoom_naar_spel` | `cockpit2.py:4755` |
| `kb_spel_start` | `cockpit2.py:4776` |
| `kb_spel_add` | `cockpit2.py:4790` |
| `kb_spel_remove` | `cockpit2.py:4800` |
| `kb_spel_flip` | `cockpit2.py:4807` |
| `kb_spel_finish` | `cockpit2.py:4813` |
| `kb_link` | `cockpit2.py:4293` |
| `kb_unlink` | `cockpit2.py:4307` |
| `kb_annotate` | `cockpit2.py:4318` |
| `kb_evidence` | `cockpit2.py:4324` |
| `kb_discuss` | `cockpit2.py:4345` |
| `kb_reformulate` | `cockpit2.py:4351` |
| `kw_nominate` | `cockpit2.py:4824` |
| `kw_nom_accept` | `cockpit2.py:4835` |
| `kw_nom_reject` | `cockpit2.py:4853` |
| `ws_forbid` | `cockpit2.py:4883` |
| `ws_approve` | `cockpit2.py:4888` |
...
| `wall_outcome` | `cockpit2.py:3120` |
| `notif_read` | `cockpit2.py:3218` |
| `notif_processed` | `cockpit2.py:3223` |
| `notif_outcome` | `cockpit2.py:3370` |
| `notif_besluit` | `cockpit2.py:3457` |
| `notif_klaar` | `cockpit2.py:3356` |
| `notif_delete` | `cockpit2.py:3228` |
| `notif_add` | `cockpit2.py:3340` |
| `notif_archive` | `cockpit2.py:3499` |
| `metrics2_fav` | `cockpit2.py:3234` |
| `metrics2_unfav` | `cockpit2.py:3244` |
| `metrics2_form` | `cockpit2.py:3249` |
| `metrics2_dim` | `cockpit2.py:3255` |
| `metrics2_compare` | `cockpit2.py:3262` |
| `metrics2_formula` | `cockpit2.py:3325` |
| `source_activate` | `cockpit2.py:3308` |
| `source_deactivate` | `cockpit2.py:3317` |
| `link_pursue` | `cockpit2.py:3289` |
| `link_ignore` | `cockpit2.py:3299` |
| `acc_check` | `cockpit2.py:3270` |
...
| `vangst_verwerk` | `cockpit2.py:2965` |
| `wo_checkout` | `cockpit2.py:3504` |
| `noochie_send` | `cockpit2.py:3519` |
| `noochie_reset` | `cockpit2.py:3545` |
| `noochie_ctx` | `cockpit2.py:3552` |
| `cl_add` | `cockpit2.py:3559` |
| `cl_report` | `cockpit2.py:3577` |
| `cl_remove` | `cockpit2.py:3592` |
| `m_add_kpi` | `cockpit2.py:3602` |
| `m_add_from_def` | `cockpit2.py:3634` |
| `def_add` | `cockpit2.py:3649` |
| `catalog_publish` | `cockpit2.py:3671` |
| `def_amend` | `cockpit2.py:3697` |
| `m_add_link` | `cockpit2.py:3739` |
| `m_sample` | `cockpit2.py:3750` |
| `m_remove` | `cockpit2.py:3760` |
| `m_pin` | `cockpit2.py:3770` |
| `m_unpin` | `cockpit2.py:3781` |
| `tile_add` | `cockpit2.py:3819` |
| `indicator_activate` | `cockpit2.py:3791` |
| `tile_remove` | `cockpit2.py:3853` |
| `rov2_set` | `cockpit2.py:3863` |
| `rov2_acc_add` | `cockpit2.py:3863` |
| `rov2_acc_remove` | `cockpit2.py:3863` |
| `rov2_dom_add` | `cockpit2.py:3863` |
| `rov2_dom_remove` | `cockpit2.py:3863` |
| `backlog_add` | `cockpit2.py:3895` |
| `backlog_update_staat` | `cockpit2.py:3907` |
| `backlog_update_prioriteit` | `cockpit2.py:3919` |
| `person_edit` | `cockpit2.py:3931` |
| `person_remove` | `cockpit2.py:3948` |
| `lk_mute` | `cockpit2.py:3969` |
| `claims_term_add` | `cockpit2.py:4072` |
| `claims_term_retract` | `cockpit2.py:4109` |
| `claims_work_status` | `cockpit2.py:4093` |
| `claims_bewijs_link` | `cockpit2.py:4138` |
| `claims_vondst_whitelist` | `cockpit2.py:4162` |
| `claims_regel_uit_vondst` | `cockpit2.py:4188` |
| `claims_to_board` | `cockpit2.py:4220` |
