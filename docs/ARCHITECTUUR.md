...
|---|---|
| `ff_beslis` | `cockpit2.py:5850` |
| `ff_cluster` | `cockpit2.py:5978` |
| `ff_promote` | `cockpit2.py:5908` |
| `ff_demote` | `cockpit2.py:5932` |
| `ff_run` | `cockpit2.py:5951` |
| `kb_new` | `cockpit2.py:5200` |
| `kb_intake` | `cockpit2.py:5282` |
| `kb_intake_url` | `cockpit2.py:5299` |
| `kb_stage_edit` | `cockpit2.py:5318` |
| `kb_stage_accept` | `cockpit2.py:5330` |
| `kb_stage_delete` | `cockpit2.py:5349` |
| `kb_stage_merge` | `cockpit2.py:5355` |
| `kb_stage_commit` | `cockpit2.py:5366` |
| `kb_stage_discard` | `cockpit2.py:5386` |
| `kb_atoom_subject` | `cockpit2.py:5641` |
| `kb_atoom_purge` | `cockpit2.py:5625` |
| `tag_voorstel_besluit` | `cockpit2.py:5462` |
| `tag_onderhoud_run` | `cockpit2.py:5612` |
| `copy_stack_inclusie` | `cockpit2.py:5594` |
| `verzoek_besluit` | `cockpit2.py:5481` |
| `kb_blacklist_leeg` | `cockpit2.py:5634` |
| `kb_atoom_edit` | `cockpit2.py:5392` |
| `kb_atoom_related` | `cockpit2.py:5399` |
| `kb_atoom_reference` | `cockpit2.py:5444` |
| `kb_insight_link` | `cockpit2.py:5411` |
| `kb_insight_unlink` | `cockpit2.py:5418` |
| `kb_meta_start` | `cockpit2.py:5424` |
| `kb_atoom_merge` | `cockpit2.py:5652` |
| `kb_atoom_archive` | `cockpit2.py:5673` |
| `kb_atoom_unarchive` | `cockpit2.py:5682` |
| `kb_atoom_naar_spel` | `cockpit2.py:5688` |
| `kb_spel_start` | `cockpit2.py:5709` |
| `kb_spel_add` | `cockpit2.py:5723` |
| `kb_spel_remove` | `cockpit2.py:5733` |
| `kb_spel_flip` | `cockpit2.py:5740` |
| `kb_spel_finish` | `cockpit2.py:5746` |
| `kb_link` | `cockpit2.py:5209` |
| `kb_unlink` | `cockpit2.py:5223` |
| `kb_annotate` | `cockpit2.py:5234` |
| `kb_evidence` | `cockpit2.py:5240` |
| `kb_discuss` | `cockpit2.py:5261` |
| `kb_reformulate` | `cockpit2.py:5267` |
| `kw_nominate` | `cockpit2.py:5757` |
| `kw_nom_accept` | `cockpit2.py:5768` |
| `kw_nom_reject` | `cockpit2.py:5786` |
| `ws_forbid` | `cockpit2.py:5829` |
| `ws_approve` | `cockpit2.py:5834` |
...
| `notif_outcome` | `cockpit2.py:4295` |
| `notif_klaar` | `cockpit2.py:4236` |
| `goedkeur` | `cockpit2.py:3981` |
| `notif_delete` | `cockpit2.py:4026` |
| `notif_add` | `cockpit2.py:4184` |
| `notif_archive` | `cockpit2.py:4417` |
...
| `metrics2_formula` | `cockpit2.py:4169` |
| `source_activate` | `cockpit2.py:4145` |
| `source_deactivate` | `cockpit2.py:4157` |
| `link_pursue` | `cockpit2.py:4119` |
| `link_ignore` | `cockpit2.py:4130` |
...
| `wo_checkout` | `cockpit2.py:4426` |
| `noochie_send` | `cockpit2.py:4441` |
| `noochie_reset` | `cockpit2.py:4468` |
| `noochie_ctx` | `cockpit2.py:4476` |
| `cl_add` | `cockpit2.py:4484` |
| `cl_report` | `cockpit2.py:4502` |
| `cl_remove` | `cockpit2.py:4517` |
| `m_add_kpi` | `cockpit2.py:4527` |
| `m_add_from_def` | `cockpit2.py:4559` |
| `def_add` | `cockpit2.py:4574` |
| `catalog_publish` | `cockpit2.py:4596` |
| `def_amend` | `cockpit2.py:4622` |
| `m_add_link` | `cockpit2.py:4664` |
| `m_sample` | `cockpit2.py:4675` |
| `m_remove` | `cockpit2.py:4685` |
| `m_pin` | `cockpit2.py:4695` |
| `m_unpin` | `cockpit2.py:4706` |
| `tile_add` | `cockpit2.py:4744` |
| `indicator_activate` | `cockpit2.py:4716` |
| `tile_remove` | `cockpit2.py:4778` |
| `rov2_set` | `cockpit2.py:4788` |
| `rov2_acc_add` | `cockpit2.py:4788` |
| `rov2_acc_remove` | `cockpit2.py:4788` |
| `rov2_dom_add` | `cockpit2.py:4788` |
| `rov2_dom_remove` | `cockpit2.py:4788` |
| `person_edit` | `cockpit2.py:4820` |
| `person_remove` | `cockpit2.py:4837` |
| `lk_mute` | `cockpit2.py:4858` |
| `claims_term_add` | `cockpit2.py:4988` |
| `claims_term_retract` | `cockpit2.py:5025` |
| `claims_work_status` | `cockpit2.py:5009` |
| `claims_bewijs_link` | `cockpit2.py:5054` |
| `claims_vondst_whitelist` | `cockpit2.py:5078` |
| `claims_regel_uit_vondst` | `cockpit2.py:5104` |
| `claims_to_board` | `cockpit2.py:5136` |
