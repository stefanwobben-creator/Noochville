...
|---|---|
| `ff_beslis` | `cockpit2.py:4960` |
| `ff_cluster` | `cockpit2.py:5088` |
| `ff_promote` | `cockpit2.py:5018` |
| `ff_demote` | `cockpit2.py:5042` |
| `ff_run` | `cockpit2.py:5061` |
| `kb_new` | `cockpit2.py:4340` |
| `kb_intake` | `cockpit2.py:4422` |
| `kb_intake_url` | `cockpit2.py:4439` |
| `kb_stage_edit` | `cockpit2.py:4458` |
| `kb_stage_accept` | `cockpit2.py:4470` |
| `kb_stage_delete` | `cockpit2.py:4489` |
| `kb_stage_merge` | `cockpit2.py:4495` |
| `kb_stage_commit` | `cockpit2.py:4506` |
| `kb_stage_discard` | `cockpit2.py:4526` |
| `kb_atoom_subject` | `cockpit2.py:4764` |
| `kb_atoom_purge` | `cockpit2.py:4748` |
| `tag_voorstel_besluit` | `cockpit2.py:4602` |
| `tag_onderhoud_run` | `cockpit2.py:4735` |
| `copy_stack_inclusie` | `cockpit2.py:4717` |
| `verzoek_besluit` | `cockpit2.py:4621` |
| `kb_blacklist_leeg` | `cockpit2.py:4757` |
| `kb_atoom_edit` | `cockpit2.py:4532` |
| `kb_atoom_related` | `cockpit2.py:4539` |
| `kb_atoom_reference` | `cockpit2.py:4584` |
| `kb_insight_link` | `cockpit2.py:4551` |
| `kb_insight_unlink` | `cockpit2.py:4558` |
| `kb_meta_start` | `cockpit2.py:4564` |
| `kb_atoom_merge` | `cockpit2.py:4775` |
| `kb_atoom_archive` | `cockpit2.py:4796` |
| `kb_atoom_unarchive` | `cockpit2.py:4805` |
| `kb_atoom_naar_spel` | `cockpit2.py:4811` |
| `kb_spel_start` | `cockpit2.py:4832` |
| `kb_spel_add` | `cockpit2.py:4846` |
| `kb_spel_remove` | `cockpit2.py:4856` |
| `kb_spel_flip` | `cockpit2.py:4863` |
| `kb_spel_finish` | `cockpit2.py:4869` |
| `kb_link` | `cockpit2.py:4349` |
| `kb_unlink` | `cockpit2.py:4363` |
| `kb_annotate` | `cockpit2.py:4374` |
| `kb_evidence` | `cockpit2.py:4380` |
| `kb_discuss` | `cockpit2.py:4401` |
| `kb_reformulate` | `cockpit2.py:4407` |
| `kw_nominate` | `cockpit2.py:4880` |
| `kw_nom_accept` | `cockpit2.py:4891` |
| `kw_nom_reject` | `cockpit2.py:4909` |
| `ws_forbid` | `cockpit2.py:4939` |
| `ws_approve` | `cockpit2.py:4944` |
...
| `wall_outcome` | `cockpit2.py:3166` |
| `notif_read` | `cockpit2.py:3264` |
| `notif_processed` | `cockpit2.py:3269` |
| `notif_outcome` | `cockpit2.py:3422` |
| `notif_besluit` | `cockpit2.py:3513` |
| `notif_klaar` | `cockpit2.py:3402` |
| `notif_delete` | `cockpit2.py:3274` |
| `notif_add` | `cockpit2.py:3386` |
| `notif_archive` | `cockpit2.py:3555` |
| `metrics2_fav` | `cockpit2.py:3280` |
| `metrics2_unfav` | `cockpit2.py:3290` |
| `metrics2_form` | `cockpit2.py:3295` |
| `metrics2_dim` | `cockpit2.py:3301` |
| `metrics2_compare` | `cockpit2.py:3308` |
| `metrics2_formula` | `cockpit2.py:3371` |
| `source_activate` | `cockpit2.py:3354` |
| `source_deactivate` | `cockpit2.py:3363` |
| `link_pursue` | `cockpit2.py:3335` |
| `link_ignore` | `cockpit2.py:3345` |
| `acc_check` | `cockpit2.py:3316` |
...
| `wo_checkout` | `cockpit2.py:3560` |
| `noochie_send` | `cockpit2.py:3575` |
| `noochie_reset` | `cockpit2.py:3601` |
| `noochie_ctx` | `cockpit2.py:3608` |
| `cl_add` | `cockpit2.py:3615` |
| `cl_report` | `cockpit2.py:3633` |
| `cl_remove` | `cockpit2.py:3648` |
| `m_add_kpi` | `cockpit2.py:3658` |
| `m_add_from_def` | `cockpit2.py:3690` |
| `def_add` | `cockpit2.py:3705` |
| `catalog_publish` | `cockpit2.py:3727` |
| `def_amend` | `cockpit2.py:3753` |
| `m_add_link` | `cockpit2.py:3795` |
| `m_sample` | `cockpit2.py:3806` |
| `m_remove` | `cockpit2.py:3816` |
| `m_pin` | `cockpit2.py:3826` |
| `m_unpin` | `cockpit2.py:3837` |
| `tile_add` | `cockpit2.py:3875` |
| `indicator_activate` | `cockpit2.py:3847` |
| `tile_remove` | `cockpit2.py:3909` |
| `rov2_set` | `cockpit2.py:3919` |
| `rov2_acc_add` | `cockpit2.py:3919` |
| `rov2_acc_remove` | `cockpit2.py:3919` |
| `rov2_dom_add` | `cockpit2.py:3919` |
| `rov2_dom_remove` | `cockpit2.py:3919` |
| `backlog_add` | `cockpit2.py:3951` |
| `backlog_update_staat` | `cockpit2.py:3963` |
| `backlog_update_prioriteit` | `cockpit2.py:3975` |
| `person_edit` | `cockpit2.py:3987` |
| `person_remove` | `cockpit2.py:4004` |
| `lk_mute` | `cockpit2.py:4025` |
| `claims_term_add` | `cockpit2.py:4128` |
| `claims_term_retract` | `cockpit2.py:4165` |
| `claims_work_status` | `cockpit2.py:4149` |
| `claims_bewijs_link` | `cockpit2.py:4194` |
| `claims_vondst_whitelist` | `cockpit2.py:4218` |
| `claims_regel_uit_vondst` | `cockpit2.py:4244` |
| `claims_to_board` | `cockpit2.py:4276` |
