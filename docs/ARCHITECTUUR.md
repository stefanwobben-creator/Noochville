...
|---|---|
| `ff_beslis` | `cockpit2.py:5251` |
| `ff_cluster` | `cockpit2.py:5379` |
| `ff_promote` | `cockpit2.py:5309` |
| `ff_demote` | `cockpit2.py:5333` |
| `ff_run` | `cockpit2.py:5352` |
| `kb_new` | `cockpit2.py:4614` |
| `kb_intake` | `cockpit2.py:4696` |
| `kb_intake_url` | `cockpit2.py:4713` |
| `kb_stage_edit` | `cockpit2.py:4732` |
| `kb_stage_accept` | `cockpit2.py:4744` |
| `kb_stage_delete` | `cockpit2.py:4763` |
| `kb_stage_merge` | `cockpit2.py:4769` |
| `kb_stage_commit` | `cockpit2.py:4780` |
| `kb_stage_discard` | `cockpit2.py:4800` |
| `kb_atoom_subject` | `cockpit2.py:5055` |
| `kb_atoom_purge` | `cockpit2.py:5039` |
| `tag_voorstel_besluit` | `cockpit2.py:4876` |
| `tag_onderhoud_run` | `cockpit2.py:5026` |
| `copy_stack_inclusie` | `cockpit2.py:5008` |
| `verzoek_besluit` | `cockpit2.py:4895` |
| `kb_blacklist_leeg` | `cockpit2.py:5048` |
| `kb_atoom_edit` | `cockpit2.py:4806` |
| `kb_atoom_related` | `cockpit2.py:4813` |
| `kb_atoom_reference` | `cockpit2.py:4858` |
| `kb_insight_link` | `cockpit2.py:4825` |
| `kb_insight_unlink` | `cockpit2.py:4832` |
| `kb_meta_start` | `cockpit2.py:4838` |
| `kb_atoom_merge` | `cockpit2.py:5066` |
| `kb_atoom_archive` | `cockpit2.py:5087` |
| `kb_atoom_unarchive` | `cockpit2.py:5096` |
| `kb_atoom_naar_spel` | `cockpit2.py:5102` |
| `kb_spel_start` | `cockpit2.py:5123` |
| `kb_spel_add` | `cockpit2.py:5137` |
| `kb_spel_remove` | `cockpit2.py:5147` |
| `kb_spel_flip` | `cockpit2.py:5154` |
| `kb_spel_finish` | `cockpit2.py:5160` |
| `kb_link` | `cockpit2.py:4623` |
| `kb_unlink` | `cockpit2.py:4637` |
| `kb_annotate` | `cockpit2.py:4648` |
| `kb_evidence` | `cockpit2.py:4654` |
| `kb_discuss` | `cockpit2.py:4675` |
| `kb_reformulate` | `cockpit2.py:4681` |
| `kw_nominate` | `cockpit2.py:5171` |
| `kw_nom_accept` | `cockpit2.py:5182` |
| `kw_nom_reject` | `cockpit2.py:5200` |
| `ws_forbid` | `cockpit2.py:5230` |
| `ws_approve` | `cockpit2.py:5235` |
...
| `wall_outcome` | `cockpit2.py:3392` |
| `notif_read` | `cockpit2.py:3488` |
| `notif_processed` | `cockpit2.py:3493` |
| `notif_outcome` | `cockpit2.py:3712` |
| `notif_klaar` | `cockpit2.py:3659` |
| `notif_delete` | `cockpit2.py:3498` |
| `notif_add` | `cockpit2.py:3610` |
| `notif_archive` | `cockpit2.py:3829` |
| `metrics2_fav` | `cockpit2.py:3504` |
| `metrics2_unfav` | `cockpit2.py:3514` |
| `metrics2_form` | `cockpit2.py:3519` |
| `metrics2_dim` | `cockpit2.py:3525` |
| `metrics2_compare` | `cockpit2.py:3532` |
| `metrics2_formula` | `cockpit2.py:3595` |
| `source_activate` | `cockpit2.py:3578` |
| `source_deactivate` | `cockpit2.py:3587` |
| `link_pursue` | `cockpit2.py:3559` |
| `link_ignore` | `cockpit2.py:3569` |
| `acc_check` | `cockpit2.py:3540` |
...
| `wo_checkout` | `cockpit2.py:3834` |
| `noochie_send` | `cockpit2.py:3849` |
| `noochie_reset` | `cockpit2.py:3875` |
| `noochie_ctx` | `cockpit2.py:3882` |
| `cl_add` | `cockpit2.py:3889` |
| `cl_report` | `cockpit2.py:3907` |
| `cl_remove` | `cockpit2.py:3922` |
| `m_add_kpi` | `cockpit2.py:3932` |
| `m_add_from_def` | `cockpit2.py:3964` |
| `def_add` | `cockpit2.py:3979` |
| `catalog_publish` | `cockpit2.py:4001` |
| `def_amend` | `cockpit2.py:4027` |
| `m_add_link` | `cockpit2.py:4069` |
| `m_sample` | `cockpit2.py:4080` |
| `m_remove` | `cockpit2.py:4090` |
| `m_pin` | `cockpit2.py:4100` |
| `m_unpin` | `cockpit2.py:4111` |
| `tile_add` | `cockpit2.py:4149` |
| `indicator_activate` | `cockpit2.py:4121` |
| `tile_remove` | `cockpit2.py:4183` |
| `rov2_set` | `cockpit2.py:4193` |
| `rov2_acc_add` | `cockpit2.py:4193` |
| `rov2_acc_remove` | `cockpit2.py:4193` |
| `rov2_dom_add` | `cockpit2.py:4193` |
| `rov2_dom_remove` | `cockpit2.py:4193` |
| `backlog_add` | `cockpit2.py:4225` |
| `backlog_update_staat` | `cockpit2.py:4237` |
| `backlog_update_prioriteit` | `cockpit2.py:4249` |
| `person_edit` | `cockpit2.py:4261` |
| `person_remove` | `cockpit2.py:4278` |
| `lk_mute` | `cockpit2.py:4299` |
| `claims_term_add` | `cockpit2.py:4402` |
| `claims_term_retract` | `cockpit2.py:4439` |
| `claims_work_status` | `cockpit2.py:4423` |
| `claims_bewijs_link` | `cockpit2.py:4468` |
| `claims_vondst_whitelist` | `cockpit2.py:4492` |
| `claims_regel_uit_vondst` | `cockpit2.py:4518` |
| `claims_to_board` | `cockpit2.py:4550` |
