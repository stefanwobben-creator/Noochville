...
| `kb_stage_delete` | `cockpit2.py:3655` |
| `kb_stage_merge` | `cockpit2.py:3661` |
| `kb_stage_commit` | `cockpit2.py:3672` |
| `kb_stage_discard` | `cockpit2.py:3692` |
| `kb_atoom_subject` | `cockpit2.py:3768` |
| `kb_atoom_edit` | `cockpit2.py:3698` |
| `kb_atoom_related` | `cockpit2.py:3705` |
| `kb_atoom_reference` | `cockpit2.py:3750` |
| `kb_insight_link` | `cockpit2.py:3717` |
| `kb_insight_unlink` | `cockpit2.py:3724` |
| `kb_meta_start` | `cockpit2.py:3730` |
| `kb_atoom_merge` | `cockpit2.py:3779` |
| `kb_atoom_archive` | `cockpit2.py:3800` |
| `kb_atoom_unarchive` | `cockpit2.py:3809` |
| `kb_atoom_naar_spel` | `cockpit2.py:3815` |
| `kb_spel_start` | `cockpit2.py:3836` |
| `kb_spel_add` | `cockpit2.py:3850` |
| `kb_spel_remove` | `cockpit2.py:3860` |
| `kb_spel_flip` | `cockpit2.py:3867` |
| `kb_spel_finish` | `cockpit2.py:3873` |
...
| `kw_nominate` | `cockpit2.py:3884` |
| `kw_nom_accept` | `cockpit2.py:3895` |
| `kw_nom_reject` | `cockpit2.py:3913` |
| `ws_forbid` | `cockpit2.py:3943` |
| `ws_approve` | `cockpit2.py:3948` |
