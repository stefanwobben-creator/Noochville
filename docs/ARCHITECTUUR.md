...
|---|---|
| `ff_beslis` | `cockpit2.py:5207` |
| `ff_cluster` | `cockpit2.py:5335` |
| `ff_promote` | `cockpit2.py:5265` |
| `ff_demote` | `cockpit2.py:5289` |
| `ff_run` | `cockpit2.py:5308` |
| `kb_new` | `cockpit2.py:4570` |
| `kb_intake` | `cockpit2.py:4652` |
| `kb_intake_url` | `cockpit2.py:4669` |
| `kb_stage_edit` | `cockpit2.py:4688` |
| `kb_stage_accept` | `cockpit2.py:4700` |
| `kb_stage_delete` | `cockpit2.py:4719` |
| `kb_stage_merge` | `cockpit2.py:4725` |
| `kb_stage_commit` | `cockpit2.py:4736` |
| `kb_stage_discard` | `cockpit2.py:4756` |
| `kb_atoom_subject` | `cockpit2.py:5011` |
| `kb_atoom_purge` | `cockpit2.py:4995` |
| `tag_voorstel_besluit` | `cockpit2.py:4832` |
| `tag_onderhoud_run` | `cockpit2.py:4982` |
| `copy_stack_inclusie` | `cockpit2.py:4964` |
| `verzoek_besluit` | `cockpit2.py:4851` |
| `kb_blacklist_leeg` | `cockpit2.py:5004` |
| `kb_atoom_edit` | `cockpit2.py:4762` |
| `kb_atoom_related` | `cockpit2.py:4769` |
| `kb_atoom_reference` | `cockpit2.py:4814` |
| `kb_insight_link` | `cockpit2.py:4781` |
| `kb_insight_unlink` | `cockpit2.py:4788` |
| `kb_meta_start` | `cockpit2.py:4794` |
| `kb_atoom_merge` | `cockpit2.py:5022` |
| `kb_atoom_archive` | `cockpit2.py:5043` |
| `kb_atoom_unarchive` | `cockpit2.py:5052` |
| `kb_atoom_naar_spel` | `cockpit2.py:5058` |
| `kb_spel_start` | `cockpit2.py:5079` |
| `kb_spel_add` | `cockpit2.py:5093` |
| `kb_spel_remove` | `cockpit2.py:5103` |
| `kb_spel_flip` | `cockpit2.py:5110` |
| `kb_spel_finish` | `cockpit2.py:5116` |
| `kb_link` | `cockpit2.py:4579` |
| `kb_unlink` | `cockpit2.py:4593` |
| `kb_annotate` | `cockpit2.py:4604` |
| `kb_evidence` | `cockpit2.py:4610` |
| `kb_discuss` | `cockpit2.py:4631` |
| `kb_reformulate` | `cockpit2.py:4637` |
| `kw_nominate` | `cockpit2.py:5127` |
| `kw_nom_accept` | `cockpit2.py:5138` |
| `kw_nom_reject` | `cockpit2.py:5156` |
| `ws_forbid` | `cockpit2.py:5186` |
| `ws_approve` | `cockpit2.py:5191` |
...
| `notif_archive` | `cockpit2.py:3785` |
...
| `wo_checkout` | `cockpit2.py:3790` |
| `noochie_send` | `cockpit2.py:3805` |
| `noochie_reset` | `cockpit2.py:3831` |
| `noochie_ctx` | `cockpit2.py:3838` |
| `cl_add` | `cockpit2.py:3845` |
| `cl_report` | `cockpit2.py:3863` |
| `cl_remove` | `cockpit2.py:3878` |
| `m_add_kpi` | `cockpit2.py:3888` |
| `m_add_from_def` | `cockpit2.py:3920` |
| `def_add` | `cockpit2.py:3935` |
| `catalog_publish` | `cockpit2.py:3957` |
| `def_amend` | `cockpit2.py:3983` |
| `m_add_link` | `cockpit2.py:4025` |
| `m_sample` | `cockpit2.py:4036` |
| `m_remove` | `cockpit2.py:4046` |
| `m_pin` | `cockpit2.py:4056` |
| `m_unpin` | `cockpit2.py:4067` |
| `tile_add` | `cockpit2.py:4105` |
| `indicator_activate` | `cockpit2.py:4077` |
| `tile_remove` | `cockpit2.py:4139` |
| `rov2_set` | `cockpit2.py:4149` |
| `rov2_acc_add` | `cockpit2.py:4149` |
| `rov2_acc_remove` | `cockpit2.py:4149` |
| `rov2_dom_add` | `cockpit2.py:4149` |
| `rov2_dom_remove` | `cockpit2.py:4149` |
| `backlog_add` | `cockpit2.py:4181` |
| `backlog_update_staat` | `cockpit2.py:4193` |
| `backlog_update_prioriteit` | `cockpit2.py:4205` |
| `person_edit` | `cockpit2.py:4217` |
| `person_remove` | `cockpit2.py:4234` |
| `lk_mute` | `cockpit2.py:4255` |
| `claims_term_add` | `cockpit2.py:4358` |
| `claims_term_retract` | `cockpit2.py:4395` |
| `claims_work_status` | `cockpit2.py:4379` |
| `claims_bewijs_link` | `cockpit2.py:4424` |
| `claims_vondst_whitelist` | `cockpit2.py:4448` |
| `claims_regel_uit_vondst` | `cockpit2.py:4474` |
| `claims_to_board` | `cockpit2.py:4506` |
