...
|---|---|
| `ff_beslis` | `cockpit2.py:5127` |
| `ff_cluster` | `cockpit2.py:5255` |
| `ff_promote` | `cockpit2.py:5185` |
| `ff_demote` | `cockpit2.py:5209` |
| `ff_run` | `cockpit2.py:5228` |
| `kb_new` | `cockpit2.py:4490` |
| `kb_intake` | `cockpit2.py:4572` |
| `kb_intake_url` | `cockpit2.py:4589` |
| `kb_stage_edit` | `cockpit2.py:4608` |
| `kb_stage_accept` | `cockpit2.py:4620` |
| `kb_stage_delete` | `cockpit2.py:4639` |
| `kb_stage_merge` | `cockpit2.py:4645` |
| `kb_stage_commit` | `cockpit2.py:4656` |
| `kb_stage_discard` | `cockpit2.py:4676` |
| `kb_atoom_subject` | `cockpit2.py:4931` |
| `kb_atoom_purge` | `cockpit2.py:4915` |
| `tag_voorstel_besluit` | `cockpit2.py:4752` |
| `tag_onderhoud_run` | `cockpit2.py:4902` |
| `copy_stack_inclusie` | `cockpit2.py:4884` |
| `verzoek_besluit` | `cockpit2.py:4771` |
| `kb_blacklist_leeg` | `cockpit2.py:4924` |
| `kb_atoom_edit` | `cockpit2.py:4682` |
| `kb_atoom_related` | `cockpit2.py:4689` |
| `kb_atoom_reference` | `cockpit2.py:4734` |
| `kb_insight_link` | `cockpit2.py:4701` |
| `kb_insight_unlink` | `cockpit2.py:4708` |
| `kb_meta_start` | `cockpit2.py:4714` |
| `kb_atoom_merge` | `cockpit2.py:4942` |
| `kb_atoom_archive` | `cockpit2.py:4963` |
| `kb_atoom_unarchive` | `cockpit2.py:4972` |
| `kb_atoom_naar_spel` | `cockpit2.py:4978` |
| `kb_spel_start` | `cockpit2.py:4999` |
| `kb_spel_add` | `cockpit2.py:5013` |
| `kb_spel_remove` | `cockpit2.py:5023` |
| `kb_spel_flip` | `cockpit2.py:5030` |
| `kb_spel_finish` | `cockpit2.py:5036` |
| `kb_link` | `cockpit2.py:4499` |
| `kb_unlink` | `cockpit2.py:4513` |
| `kb_annotate` | `cockpit2.py:4524` |
| `kb_evidence` | `cockpit2.py:4530` |
| `kb_discuss` | `cockpit2.py:4551` |
| `kb_reformulate` | `cockpit2.py:4557` |
| `kw_nominate` | `cockpit2.py:5047` |
| `kw_nom_accept` | `cockpit2.py:5058` |
| `kw_nom_reject` | `cockpit2.py:5076` |
| `ws_forbid` | `cockpit2.py:5106` |
| `ws_approve` | `cockpit2.py:5111` |
...
| `wall_outcome` | `cockpit2.py:3310` |
| `notif_read` | `cockpit2.py:3406` |
| `notif_processed` | `cockpit2.py:3411` |
| `notif_outcome` | `cockpit2.py:3614` |
| `notif_klaar` | `cockpit2.py:3577` |
| `notif_delete` | `cockpit2.py:3416` |
| `notif_add` | `cockpit2.py:3528` |
| `notif_archive` | `cockpit2.py:3705` |
| `metrics2_fav` | `cockpit2.py:3422` |
| `metrics2_unfav` | `cockpit2.py:3432` |
| `metrics2_form` | `cockpit2.py:3437` |
| `metrics2_dim` | `cockpit2.py:3443` |
| `metrics2_compare` | `cockpit2.py:3450` |
| `metrics2_formula` | `cockpit2.py:3513` |
| `source_activate` | `cockpit2.py:3496` |
| `source_deactivate` | `cockpit2.py:3505` |
| `link_pursue` | `cockpit2.py:3477` |
| `link_ignore` | `cockpit2.py:3487` |
| `acc_check` | `cockpit2.py:3458` |
...
| `wo_checkout` | `cockpit2.py:3710` |
| `noochie_send` | `cockpit2.py:3725` |
| `noochie_reset` | `cockpit2.py:3751` |
| `noochie_ctx` | `cockpit2.py:3758` |
| `cl_add` | `cockpit2.py:3765` |
| `cl_report` | `cockpit2.py:3783` |
| `cl_remove` | `cockpit2.py:3798` |
| `m_add_kpi` | `cockpit2.py:3808` |
| `m_add_from_def` | `cockpit2.py:3840` |
| `def_add` | `cockpit2.py:3855` |
| `catalog_publish` | `cockpit2.py:3877` |
| `def_amend` | `cockpit2.py:3903` |
| `m_add_link` | `cockpit2.py:3945` |
| `m_sample` | `cockpit2.py:3956` |
| `m_remove` | `cockpit2.py:3966` |
| `m_pin` | `cockpit2.py:3976` |
| `m_unpin` | `cockpit2.py:3987` |
| `tile_add` | `cockpit2.py:4025` |
| `indicator_activate` | `cockpit2.py:3997` |
| `tile_remove` | `cockpit2.py:4059` |
| `rov2_set` | `cockpit2.py:4069` |
| `rov2_acc_add` | `cockpit2.py:4069` |
| `rov2_acc_remove` | `cockpit2.py:4069` |
| `rov2_dom_add` | `cockpit2.py:4069` |
| `rov2_dom_remove` | `cockpit2.py:4069` |
| `backlog_add` | `cockpit2.py:4101` |
| `backlog_update_staat` | `cockpit2.py:4113` |
| `backlog_update_prioriteit` | `cockpit2.py:4125` |
| `person_edit` | `cockpit2.py:4137` |
| `person_remove` | `cockpit2.py:4154` |
| `lk_mute` | `cockpit2.py:4175` |
| `claims_term_add` | `cockpit2.py:4278` |
| `claims_term_retract` | `cockpit2.py:4315` |
| `claims_work_status` | `cockpit2.py:4299` |
| `claims_bewijs_link` | `cockpit2.py:4344` |
| `claims_vondst_whitelist` | `cockpit2.py:4368` |
| `claims_regel_uit_vondst` | `cockpit2.py:4394` |
| `claims_to_board` | `cockpit2.py:4426` |
