...
| `notif_outcome` | `cockpit2.py:2366` |
| `notif_klaar` | `cockpit2.py:2352` |
| `notif_delete` | `cockpit2.py:2279` |
| `notif_add` | `cockpit2.py:2336` |
| `notif_archive` | `cockpit2.py:2453` |
...
| `metrics2_formula` | `cockpit2.py:2321` |
...
| `wo_checkout` | `cockpit2.py:2458` |
| `noochie_send` | `cockpit2.py:2470` |
| `noochie_reset` | `cockpit2.py:2496` |
| `noochie_ctx` | `cockpit2.py:2503` |
| `cl_add` | `cockpit2.py:2510` |
| `cl_report` | `cockpit2.py:2528` |
| `cl_remove` | `cockpit2.py:2543` |
| `m_add_kpi` | `cockpit2.py:2553` |
| `m_add_from_def` | `cockpit2.py:2585` |
| `def_add` | `cockpit2.py:2600` |
| `catalog_publish` | `cockpit2.py:2622` |
| `def_amend` | `cockpit2.py:2648` |
| `m_add_link` | `cockpit2.py:2690` |
| `m_sample` | `cockpit2.py:2701` |
| `m_remove` | `cockpit2.py:2711` |
| `m_pin` | `cockpit2.py:2721` |
| `m_unpin` | `cockpit2.py:2732` |
| `tile_add` | `cockpit2.py:2770` |
| `indicator_activate` | `cockpit2.py:2742` |
| `tile_remove` | `cockpit2.py:2804` |
| `rov2_set` | `cockpit2.py:2814` |
| `rov2_acc_add` | `cockpit2.py:2814` |
| `rov2_acc_remove` | `cockpit2.py:2814` |
| `rov2_dom_add` | `cockpit2.py:2814` |
| `rov2_dom_remove` | `cockpit2.py:2814` |
| `backlog_add` | `cockpit2.py:2846` |
| `backlog_update_staat` | `cockpit2.py:2858` |
| `backlog_update_prioriteit` | `cockpit2.py:2870` |
| `person_edit` | `cockpit2.py:2882` |
| `person_remove` | `cockpit2.py:2899` |
| `lk_mute` | `cockpit2.py:2920` |
...
---
_30 routes · 107 dispatch-acties · 22 stores._
