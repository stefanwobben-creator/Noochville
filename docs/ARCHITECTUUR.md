...
|---|---|
| `ff_beslis` | `cockpit2.py:5547` |
| `ff_cluster` | `cockpit2.py:5675` |
| `ff_promote` | `cockpit2.py:5605` |
| `ff_demote` | `cockpit2.py:5629` |
| `ff_run` | `cockpit2.py:5648` |
| `kb_new` | `cockpit2.py:4910` |
| `kb_intake` | `cockpit2.py:4992` |
| `kb_intake_url` | `cockpit2.py:5009` |
| `kb_stage_edit` | `cockpit2.py:5028` |
| `kb_stage_accept` | `cockpit2.py:5040` |
| `kb_stage_delete` | `cockpit2.py:5059` |
| `kb_stage_merge` | `cockpit2.py:5065` |
| `kb_stage_commit` | `cockpit2.py:5076` |
| `kb_stage_discard` | `cockpit2.py:5096` |
| `kb_atoom_subject` | `cockpit2.py:5351` |
| `kb_atoom_purge` | `cockpit2.py:5335` |
| `tag_voorstel_besluit` | `cockpit2.py:5172` |
| `tag_onderhoud_run` | `cockpit2.py:5322` |
| `copy_stack_inclusie` | `cockpit2.py:5304` |
| `verzoek_besluit` | `cockpit2.py:5191` |
| `kb_blacklist_leeg` | `cockpit2.py:5344` |
| `kb_atoom_edit` | `cockpit2.py:5102` |
| `kb_atoom_related` | `cockpit2.py:5109` |
| `kb_atoom_reference` | `cockpit2.py:5154` |
| `kb_insight_link` | `cockpit2.py:5121` |
| `kb_insight_unlink` | `cockpit2.py:5128` |
| `kb_meta_start` | `cockpit2.py:5134` |
| `kb_atoom_merge` | `cockpit2.py:5362` |
| `kb_atoom_archive` | `cockpit2.py:5383` |
| `kb_atoom_unarchive` | `cockpit2.py:5392` |
| `kb_atoom_naar_spel` | `cockpit2.py:5398` |
| `kb_spel_start` | `cockpit2.py:5419` |
| `kb_spel_add` | `cockpit2.py:5433` |
| `kb_spel_remove` | `cockpit2.py:5443` |
| `kb_spel_flip` | `cockpit2.py:5450` |
| `kb_spel_finish` | `cockpit2.py:5456` |
| `kb_link` | `cockpit2.py:4919` |
| `kb_unlink` | `cockpit2.py:4933` |
| `kb_annotate` | `cockpit2.py:4944` |
| `kb_evidence` | `cockpit2.py:4950` |
| `kb_discuss` | `cockpit2.py:4971` |
| `kb_reformulate` | `cockpit2.py:4977` |
| `kw_nominate` | `cockpit2.py:5467` |
| `kw_nom_accept` | `cockpit2.py:5478` |
| `kw_nom_reject` | `cockpit2.py:5496` |
| `ws_forbid` | `cockpit2.py:5526` |
| `ws_approve` | `cockpit2.py:5531` |
...
| `notif_outcome` | `cockpit2.py:4008` |
| `notif_klaar` | `cockpit2.py:3955` |
| `goedkeur` | `cockpit2.py:3749` |
| `notif_delete` | `cockpit2.py:3794` |
| `notif_add` | `cockpit2.py:3906` |
| `notif_archive` | `cockpit2.py:4125` |
| `metrics2_fav` | `cockpit2.py:3800` |
| `metrics2_unfav` | `cockpit2.py:3810` |
| `metrics2_form` | `cockpit2.py:3815` |
| `metrics2_dim` | `cockpit2.py:3821` |
| `metrics2_compare` | `cockpit2.py:3828` |
| `metrics2_formula` | `cockpit2.py:3891` |
| `source_activate` | `cockpit2.py:3874` |
| `source_deactivate` | `cockpit2.py:3883` |
| `link_pursue` | `cockpit2.py:3855` |
| `link_ignore` | `cockpit2.py:3865` |
| `acc_check` | `cockpit2.py:3836` |
...
| `wo_checkout` | `cockpit2.py:4130` |
| `noochie_send` | `cockpit2.py:4145` |
| `noochie_reset` | `cockpit2.py:4171` |
| `noochie_ctx` | `cockpit2.py:4178` |
| `cl_add` | `cockpit2.py:4185` |
| `cl_report` | `cockpit2.py:4203` |
| `cl_remove` | `cockpit2.py:4218` |
| `m_add_kpi` | `cockpit2.py:4228` |
| `m_add_from_def` | `cockpit2.py:4260` |
| `def_add` | `cockpit2.py:4275` |
| `catalog_publish` | `cockpit2.py:4297` |
| `def_amend` | `cockpit2.py:4323` |
| `m_add_link` | `cockpit2.py:4365` |
| `m_sample` | `cockpit2.py:4376` |
| `m_remove` | `cockpit2.py:4386` |
| `m_pin` | `cockpit2.py:4396` |
| `m_unpin` | `cockpit2.py:4407` |
| `tile_add` | `cockpit2.py:4445` |
| `indicator_activate` | `cockpit2.py:4417` |
| `tile_remove` | `cockpit2.py:4479` |
| `rov2_set` | `cockpit2.py:4489` |
| `rov2_acc_add` | `cockpit2.py:4489` |
| `rov2_acc_remove` | `cockpit2.py:4489` |
| `rov2_dom_add` | `cockpit2.py:4489` |
| `rov2_dom_remove` | `cockpit2.py:4489` |
| `backlog_add` | `cockpit2.py:4521` |
| `backlog_update_staat` | `cockpit2.py:4533` |
| `backlog_update_prioriteit` | `cockpit2.py:4545` |
| `person_edit` | `cockpit2.py:4557` |
| `person_remove` | `cockpit2.py:4574` |
| `lk_mute` | `cockpit2.py:4595` |
| `claims_term_add` | `cockpit2.py:4698` |
| `claims_term_retract` | `cockpit2.py:4735` |
| `claims_work_status` | `cockpit2.py:4719` |
| `claims_bewijs_link` | `cockpit2.py:4764` |
| `claims_vondst_whitelist` | `cockpit2.py:4788` |
| `claims_regel_uit_vondst` | `cockpit2.py:4814` |
| `claims_to_board` | `cockpit2.py:4846` |
