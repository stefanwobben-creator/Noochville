...
|---|---|
| `ff_beslis` | `cockpit2.py:4976` |
| `ff_cluster` | `cockpit2.py:5104` |
| `ff_promote` | `cockpit2.py:5034` |
| `ff_demote` | `cockpit2.py:5058` |
| `ff_run` | `cockpit2.py:5077` |
| `kb_new` | `cockpit2.py:4356` |
| `kb_intake` | `cockpit2.py:4438` |
| `kb_intake_url` | `cockpit2.py:4455` |
| `kb_stage_edit` | `cockpit2.py:4474` |
| `kb_stage_accept` | `cockpit2.py:4486` |
| `kb_stage_delete` | `cockpit2.py:4505` |
| `kb_stage_merge` | `cockpit2.py:4511` |
| `kb_stage_commit` | `cockpit2.py:4522` |
| `kb_stage_discard` | `cockpit2.py:4542` |
| `kb_atoom_subject` | `cockpit2.py:4780` |
| `kb_atoom_purge` | `cockpit2.py:4764` |
| `tag_voorstel_besluit` | `cockpit2.py:4618` |
| `tag_onderhoud_run` | `cockpit2.py:4751` |
| `copy_stack_inclusie` | `cockpit2.py:4733` |
| `verzoek_besluit` | `cockpit2.py:4637` |
| `kb_blacklist_leeg` | `cockpit2.py:4773` |
| `kb_atoom_edit` | `cockpit2.py:4548` |
| `kb_atoom_related` | `cockpit2.py:4555` |
| `kb_atoom_reference` | `cockpit2.py:4600` |
| `kb_insight_link` | `cockpit2.py:4567` |
| `kb_insight_unlink` | `cockpit2.py:4574` |
| `kb_meta_start` | `cockpit2.py:4580` |
| `kb_atoom_merge` | `cockpit2.py:4791` |
| `kb_atoom_archive` | `cockpit2.py:4812` |
| `kb_atoom_unarchive` | `cockpit2.py:4821` |
| `kb_atoom_naar_spel` | `cockpit2.py:4827` |
| `kb_spel_start` | `cockpit2.py:4848` |
| `kb_spel_add` | `cockpit2.py:4862` |
| `kb_spel_remove` | `cockpit2.py:4872` |
| `kb_spel_flip` | `cockpit2.py:4879` |
| `kb_spel_finish` | `cockpit2.py:4885` |
| `kb_link` | `cockpit2.py:4365` |
| `kb_unlink` | `cockpit2.py:4379` |
| `kb_annotate` | `cockpit2.py:4390` |
| `kb_evidence` | `cockpit2.py:4396` |
| `kb_discuss` | `cockpit2.py:4417` |
| `kb_reformulate` | `cockpit2.py:4423` |
| `kw_nominate` | `cockpit2.py:4896` |
| `kw_nom_accept` | `cockpit2.py:4907` |
| `kw_nom_reject` | `cockpit2.py:4925` |
| `ws_forbid` | `cockpit2.py:4955` |
| `ws_approve` | `cockpit2.py:4960` |
...
| `notif_outcome` | `cockpit2.py:3480` |
| `notif_klaar` | `cockpit2.py:3443` |
| `notif_delete` | `cockpit2.py:3288` |
| `notif_add` | `cockpit2.py:3400` |
| `notif_archive` | `cockpit2.py:3571` |
...
| `wo_checkout` | `cockpit2.py:3576` |
| `noochie_send` | `cockpit2.py:3591` |
| `noochie_reset` | `cockpit2.py:3617` |
| `noochie_ctx` | `cockpit2.py:3624` |
| `cl_add` | `cockpit2.py:3631` |
| `cl_report` | `cockpit2.py:3649` |
| `cl_remove` | `cockpit2.py:3664` |
| `m_add_kpi` | `cockpit2.py:3674` |
| `m_add_from_def` | `cockpit2.py:3706` |
| `def_add` | `cockpit2.py:3721` |
| `catalog_publish` | `cockpit2.py:3743` |
| `def_amend` | `cockpit2.py:3769` |
| `m_add_link` | `cockpit2.py:3811` |
| `m_sample` | `cockpit2.py:3822` |
| `m_remove` | `cockpit2.py:3832` |
| `m_pin` | `cockpit2.py:3842` |
| `m_unpin` | `cockpit2.py:3853` |
| `tile_add` | `cockpit2.py:3891` |
| `indicator_activate` | `cockpit2.py:3863` |
| `tile_remove` | `cockpit2.py:3925` |
| `rov2_set` | `cockpit2.py:3935` |
| `rov2_acc_add` | `cockpit2.py:3935` |
| `rov2_acc_remove` | `cockpit2.py:3935` |
| `rov2_dom_add` | `cockpit2.py:3935` |
| `rov2_dom_remove` | `cockpit2.py:3935` |
| `backlog_add` | `cockpit2.py:3967` |
| `backlog_update_staat` | `cockpit2.py:3979` |
| `backlog_update_prioriteit` | `cockpit2.py:3991` |
| `person_edit` | `cockpit2.py:4003` |
| `person_remove` | `cockpit2.py:4020` |
| `lk_mute` | `cockpit2.py:4041` |
| `claims_term_add` | `cockpit2.py:4144` |
| `claims_term_retract` | `cockpit2.py:4181` |
| `claims_work_status` | `cockpit2.py:4165` |
| `claims_bewijs_link` | `cockpit2.py:4210` |
| `claims_vondst_whitelist` | `cockpit2.py:4234` |
| `claims_regel_uit_vondst` | `cockpit2.py:4260` |
| `claims_to_board` | `cockpit2.py:4292` |
