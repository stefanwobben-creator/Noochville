...
|---|---|
| `ff_beslis` | `cockpit2.py:5070` |
| `ff_cluster` | `cockpit2.py:5198` |
| `ff_promote` | `cockpit2.py:5128` |
| `ff_demote` | `cockpit2.py:5152` |
| `ff_run` | `cockpit2.py:5171` |
| `kb_new` | `cockpit2.py:4441` |
| `kb_intake` | `cockpit2.py:4523` |
| `kb_intake_url` | `cockpit2.py:4540` |
| `kb_stage_edit` | `cockpit2.py:4559` |
| `kb_stage_accept` | `cockpit2.py:4571` |
| `kb_stage_delete` | `cockpit2.py:4590` |
| `kb_stage_merge` | `cockpit2.py:4596` |
| `kb_stage_commit` | `cockpit2.py:4607` |
| `kb_stage_discard` | `cockpit2.py:4627` |
| `kb_atoom_subject` | `cockpit2.py:4874` |
| `kb_atoom_purge` | `cockpit2.py:4858` |
| `tag_voorstel_besluit` | `cockpit2.py:4703` |
| `tag_onderhoud_run` | `cockpit2.py:4845` |
| `copy_stack_inclusie` | `cockpit2.py:4827` |
| `verzoek_besluit` | `cockpit2.py:4722` |
| `kb_blacklist_leeg` | `cockpit2.py:4867` |
| `kb_atoom_edit` | `cockpit2.py:4633` |
| `kb_atoom_related` | `cockpit2.py:4640` |
| `kb_atoom_reference` | `cockpit2.py:4685` |
| `kb_insight_link` | `cockpit2.py:4652` |
| `kb_insight_unlink` | `cockpit2.py:4659` |
| `kb_meta_start` | `cockpit2.py:4665` |
| `kb_atoom_merge` | `cockpit2.py:4885` |
| `kb_atoom_archive` | `cockpit2.py:4906` |
| `kb_atoom_unarchive` | `cockpit2.py:4915` |
| `kb_atoom_naar_spel` | `cockpit2.py:4921` |
| `kb_spel_start` | `cockpit2.py:4942` |
| `kb_spel_add` | `cockpit2.py:4956` |
| `kb_spel_remove` | `cockpit2.py:4966` |
| `kb_spel_flip` | `cockpit2.py:4973` |
| `kb_spel_finish` | `cockpit2.py:4979` |
| `kb_link` | `cockpit2.py:4450` |
| `kb_unlink` | `cockpit2.py:4464` |
| `kb_annotate` | `cockpit2.py:4475` |
| `kb_evidence` | `cockpit2.py:4481` |
| `kb_discuss` | `cockpit2.py:4502` |
| `kb_reformulate` | `cockpit2.py:4508` |
| `kw_nominate` | `cockpit2.py:4990` |
| `kw_nom_accept` | `cockpit2.py:5001` |
| `kw_nom_reject` | `cockpit2.py:5019` |
| `ws_forbid` | `cockpit2.py:5049` |
| `ws_approve` | `cockpit2.py:5054` |
...
| `wall_outcome` | `cockpit2.py:3267` |
| `notif_read` | `cockpit2.py:3363` |
| `notif_processed` | `cockpit2.py:3368` |
| `notif_outcome` | `cockpit2.py:3565` |
| `notif_klaar` | `cockpit2.py:3528` |
| `notif_delete` | `cockpit2.py:3373` |
| `notif_add` | `cockpit2.py:3485` |
| `notif_archive` | `cockpit2.py:3656` |
| `metrics2_fav` | `cockpit2.py:3379` |
| `metrics2_unfav` | `cockpit2.py:3389` |
| `metrics2_form` | `cockpit2.py:3394` |
| `metrics2_dim` | `cockpit2.py:3400` |
| `metrics2_compare` | `cockpit2.py:3407` |
| `metrics2_formula` | `cockpit2.py:3470` |
| `source_activate` | `cockpit2.py:3453` |
| `source_deactivate` | `cockpit2.py:3462` |
| `link_pursue` | `cockpit2.py:3434` |
| `link_ignore` | `cockpit2.py:3444` |
| `acc_check` | `cockpit2.py:3415` |
...
| `wo_checkout` | `cockpit2.py:3661` |
| `noochie_send` | `cockpit2.py:3676` |
| `noochie_reset` | `cockpit2.py:3702` |
| `noochie_ctx` | `cockpit2.py:3709` |
| `cl_add` | `cockpit2.py:3716` |
| `cl_report` | `cockpit2.py:3734` |
| `cl_remove` | `cockpit2.py:3749` |
| `m_add_kpi` | `cockpit2.py:3759` |
| `m_add_from_def` | `cockpit2.py:3791` |
| `def_add` | `cockpit2.py:3806` |
| `catalog_publish` | `cockpit2.py:3828` |
| `def_amend` | `cockpit2.py:3854` |
| `m_add_link` | `cockpit2.py:3896` |
| `m_sample` | `cockpit2.py:3907` |
| `m_remove` | `cockpit2.py:3917` |
| `m_pin` | `cockpit2.py:3927` |
| `m_unpin` | `cockpit2.py:3938` |
| `tile_add` | `cockpit2.py:3976` |
| `indicator_activate` | `cockpit2.py:3948` |
| `tile_remove` | `cockpit2.py:4010` |
| `rov2_set` | `cockpit2.py:4020` |
| `rov2_acc_add` | `cockpit2.py:4020` |
| `rov2_acc_remove` | `cockpit2.py:4020` |
| `rov2_dom_add` | `cockpit2.py:4020` |
| `rov2_dom_remove` | `cockpit2.py:4020` |
| `backlog_add` | `cockpit2.py:4052` |
| `backlog_update_staat` | `cockpit2.py:4064` |
| `backlog_update_prioriteit` | `cockpit2.py:4076` |
| `person_edit` | `cockpit2.py:4088` |
| `person_remove` | `cockpit2.py:4105` |
| `lk_mute` | `cockpit2.py:4126` |
| `claims_term_add` | `cockpit2.py:4229` |
| `claims_term_retract` | `cockpit2.py:4266` |
| `claims_work_status` | `cockpit2.py:4250` |
| `claims_bewijs_link` | `cockpit2.py:4295` |
| `claims_vondst_whitelist` | `cockpit2.py:4319` |
| `claims_regel_uit_vondst` | `cockpit2.py:4345` |
| `claims_to_board` | `cockpit2.py:4377` |
