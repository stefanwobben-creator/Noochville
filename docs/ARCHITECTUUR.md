...
|---|---|
| `ff_beslis` | `cockpit2.py:5261` |
| `ff_cluster` | `cockpit2.py:5389` |
| `ff_promote` | `cockpit2.py:5319` |
| `ff_demote` | `cockpit2.py:5343` |
| `ff_run` | `cockpit2.py:5362` |
| `kb_new` | `cockpit2.py:4624` |
| `kb_intake` | `cockpit2.py:4706` |
| `kb_intake_url` | `cockpit2.py:4723` |
| `kb_stage_edit` | `cockpit2.py:4742` |
| `kb_stage_accept` | `cockpit2.py:4754` |
| `kb_stage_delete` | `cockpit2.py:4773` |
| `kb_stage_merge` | `cockpit2.py:4779` |
| `kb_stage_commit` | `cockpit2.py:4790` |
| `kb_stage_discard` | `cockpit2.py:4810` |
| `kb_atoom_subject` | `cockpit2.py:5065` |
| `kb_atoom_purge` | `cockpit2.py:5049` |
| `tag_voorstel_besluit` | `cockpit2.py:4886` |
| `tag_onderhoud_run` | `cockpit2.py:5036` |
| `copy_stack_inclusie` | `cockpit2.py:5018` |
| `verzoek_besluit` | `cockpit2.py:4905` |
| `kb_blacklist_leeg` | `cockpit2.py:5058` |
| `kb_atoom_edit` | `cockpit2.py:4816` |
| `kb_atoom_related` | `cockpit2.py:4823` |
| `kb_atoom_reference` | `cockpit2.py:4868` |
| `kb_insight_link` | `cockpit2.py:4835` |
| `kb_insight_unlink` | `cockpit2.py:4842` |
| `kb_meta_start` | `cockpit2.py:4848` |
| `kb_atoom_merge` | `cockpit2.py:5076` |
| `kb_atoom_archive` | `cockpit2.py:5097` |
| `kb_atoom_unarchive` | `cockpit2.py:5106` |
| `kb_atoom_naar_spel` | `cockpit2.py:5112` |
| `kb_spel_start` | `cockpit2.py:5133` |
| `kb_spel_add` | `cockpit2.py:5147` |
| `kb_spel_remove` | `cockpit2.py:5157` |
| `kb_spel_flip` | `cockpit2.py:5164` |
| `kb_spel_finish` | `cockpit2.py:5170` |
| `kb_link` | `cockpit2.py:4633` |
| `kb_unlink` | `cockpit2.py:4647` |
| `kb_annotate` | `cockpit2.py:4658` |
| `kb_evidence` | `cockpit2.py:4664` |
| `kb_discuss` | `cockpit2.py:4685` |
| `kb_reformulate` | `cockpit2.py:4691` |
| `kw_nominate` | `cockpit2.py:5181` |
| `kw_nom_accept` | `cockpit2.py:5192` |
| `kw_nom_reject` | `cockpit2.py:5210` |
| `ws_forbid` | `cockpit2.py:5240` |
| `ws_approve` | `cockpit2.py:5245` |
...
| `wall_outcome` | `cockpit2.py:3402` |
| `notif_read` | `cockpit2.py:3498` |
| `notif_processed` | `cockpit2.py:3503` |
| `notif_outcome` | `cockpit2.py:3722` |
| `notif_klaar` | `cockpit2.py:3669` |
| `notif_delete` | `cockpit2.py:3508` |
| `notif_add` | `cockpit2.py:3620` |
| `notif_archive` | `cockpit2.py:3839` |
| `metrics2_fav` | `cockpit2.py:3514` |
| `metrics2_unfav` | `cockpit2.py:3524` |
| `metrics2_form` | `cockpit2.py:3529` |
| `metrics2_dim` | `cockpit2.py:3535` |
| `metrics2_compare` | `cockpit2.py:3542` |
| `metrics2_formula` | `cockpit2.py:3605` |
| `source_activate` | `cockpit2.py:3588` |
| `source_deactivate` | `cockpit2.py:3597` |
| `link_pursue` | `cockpit2.py:3569` |
| `link_ignore` | `cockpit2.py:3579` |
| `acc_check` | `cockpit2.py:3550` |
...
| `wo_checkout` | `cockpit2.py:3844` |
| `noochie_send` | `cockpit2.py:3859` |
| `noochie_reset` | `cockpit2.py:3885` |
| `noochie_ctx` | `cockpit2.py:3892` |
| `cl_add` | `cockpit2.py:3899` |
| `cl_report` | `cockpit2.py:3917` |
| `cl_remove` | `cockpit2.py:3932` |
| `m_add_kpi` | `cockpit2.py:3942` |
| `m_add_from_def` | `cockpit2.py:3974` |
| `def_add` | `cockpit2.py:3989` |
| `catalog_publish` | `cockpit2.py:4011` |
| `def_amend` | `cockpit2.py:4037` |
| `m_add_link` | `cockpit2.py:4079` |
| `m_sample` | `cockpit2.py:4090` |
| `m_remove` | `cockpit2.py:4100` |
| `m_pin` | `cockpit2.py:4110` |
| `m_unpin` | `cockpit2.py:4121` |
| `tile_add` | `cockpit2.py:4159` |
| `indicator_activate` | `cockpit2.py:4131` |
| `tile_remove` | `cockpit2.py:4193` |
| `rov2_set` | `cockpit2.py:4203` |
| `rov2_acc_add` | `cockpit2.py:4203` |
| `rov2_acc_remove` | `cockpit2.py:4203` |
| `rov2_dom_add` | `cockpit2.py:4203` |
| `rov2_dom_remove` | `cockpit2.py:4203` |
| `backlog_add` | `cockpit2.py:4235` |
| `backlog_update_staat` | `cockpit2.py:4247` |
| `backlog_update_prioriteit` | `cockpit2.py:4259` |
| `person_edit` | `cockpit2.py:4271` |
| `person_remove` | `cockpit2.py:4288` |
| `lk_mute` | `cockpit2.py:4309` |
| `claims_term_add` | `cockpit2.py:4412` |
| `claims_term_retract` | `cockpit2.py:4449` |
| `claims_work_status` | `cockpit2.py:4433` |
| `claims_bewijs_link` | `cockpit2.py:4478` |
| `claims_vondst_whitelist` | `cockpit2.py:4502` |
| `claims_regel_uit_vondst` | `cockpit2.py:4528` |
| `claims_to_board` | `cockpit2.py:4560` |
