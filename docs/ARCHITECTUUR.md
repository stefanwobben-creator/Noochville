...
|---|---|
| `ff_beslis` | `cockpit2.py:4839` |
| `ff_cluster` | `cockpit2.py:4967` |
| `ff_promote` | `cockpit2.py:4897` |
| `ff_demote` | `cockpit2.py:4921` |
| `ff_run` | `cockpit2.py:4940` |
| `kb_new` | `cockpit2.py:4219` |
| `kb_intake` | `cockpit2.py:4301` |
| `kb_intake_url` | `cockpit2.py:4318` |
| `kb_stage_edit` | `cockpit2.py:4337` |
| `kb_stage_accept` | `cockpit2.py:4349` |
| `kb_stage_delete` | `cockpit2.py:4368` |
| `kb_stage_merge` | `cockpit2.py:4374` |
| `kb_stage_commit` | `cockpit2.py:4385` |
| `kb_stage_discard` | `cockpit2.py:4405` |
| `kb_atoom_subject` | `cockpit2.py:4643` |
| `kb_atoom_purge` | `cockpit2.py:4627` |
| `tag_voorstel_besluit` | `cockpit2.py:4481` |
| `tag_onderhoud_run` | `cockpit2.py:4614` |
| `copy_stack_inclusie` | `cockpit2.py:4596` |
| `verzoek_besluit` | `cockpit2.py:4500` |
| `kb_blacklist_leeg` | `cockpit2.py:4636` |
| `kb_atoom_edit` | `cockpit2.py:4411` |
| `kb_atoom_related` | `cockpit2.py:4418` |
| `kb_atoom_reference` | `cockpit2.py:4463` |
| `kb_insight_link` | `cockpit2.py:4430` |
| `kb_insight_unlink` | `cockpit2.py:4437` |
| `kb_meta_start` | `cockpit2.py:4443` |
| `kb_atoom_merge` | `cockpit2.py:4654` |
| `kb_atoom_archive` | `cockpit2.py:4675` |
| `kb_atoom_unarchive` | `cockpit2.py:4684` |
| `kb_atoom_naar_spel` | `cockpit2.py:4690` |
| `kb_spel_start` | `cockpit2.py:4711` |
| `kb_spel_add` | `cockpit2.py:4725` |
| `kb_spel_remove` | `cockpit2.py:4735` |
| `kb_spel_flip` | `cockpit2.py:4742` |
| `kb_spel_finish` | `cockpit2.py:4748` |
| `kb_link` | `cockpit2.py:4228` |
| `kb_unlink` | `cockpit2.py:4242` |
| `kb_annotate` | `cockpit2.py:4253` |
| `kb_evidence` | `cockpit2.py:4259` |
| `kb_discuss` | `cockpit2.py:4280` |
| `kb_reformulate` | `cockpit2.py:4286` |
| `kw_nominate` | `cockpit2.py:4759` |
| `kw_nom_accept` | `cockpit2.py:4770` |
| `kw_nom_reject` | `cockpit2.py:4788` |
| `ws_forbid` | `cockpit2.py:4818` |
| `ws_approve` | `cockpit2.py:4823` |
...
| `wall_outcome` | `cockpit2.py:3058` |
| `notif_read` | `cockpit2.py:3156` |
| `notif_processed` | `cockpit2.py:3161` |
| `notif_outcome` | `cockpit2.py:3308` |
| `notif_besluit` | `cockpit2.py:3395` |
| `notif_klaar` | `cockpit2.py:3294` |
| `notif_delete` | `cockpit2.py:3166` |
| `notif_add` | `cockpit2.py:3278` |
| `notif_archive` | `cockpit2.py:3437` |
| `metrics2_fav` | `cockpit2.py:3172` |
| `metrics2_unfav` | `cockpit2.py:3182` |
| `metrics2_form` | `cockpit2.py:3187` |
| `metrics2_dim` | `cockpit2.py:3193` |
| `metrics2_compare` | `cockpit2.py:3200` |
| `metrics2_formula` | `cockpit2.py:3263` |
| `source_activate` | `cockpit2.py:3246` |
| `source_deactivate` | `cockpit2.py:3255` |
| `link_pursue` | `cockpit2.py:3227` |
| `link_ignore` | `cockpit2.py:3237` |
| `acc_check` | `cockpit2.py:3208` |
...
| `vangst_verwerk` | `cockpit2.py:2906` |
| `wo_checkout` | `cockpit2.py:3442` |
| `noochie_send` | `cockpit2.py:3454` |
| `noochie_reset` | `cockpit2.py:3480` |
| `noochie_ctx` | `cockpit2.py:3487` |
| `cl_add` | `cockpit2.py:3494` |
| `cl_report` | `cockpit2.py:3512` |
| `cl_remove` | `cockpit2.py:3527` |
| `m_add_kpi` | `cockpit2.py:3537` |
| `m_add_from_def` | `cockpit2.py:3569` |
| `def_add` | `cockpit2.py:3584` |
| `catalog_publish` | `cockpit2.py:3606` |
| `def_amend` | `cockpit2.py:3632` |
| `m_add_link` | `cockpit2.py:3674` |
| `m_sample` | `cockpit2.py:3685` |
| `m_remove` | `cockpit2.py:3695` |
| `m_pin` | `cockpit2.py:3705` |
| `m_unpin` | `cockpit2.py:3716` |
| `tile_add` | `cockpit2.py:3754` |
| `indicator_activate` | `cockpit2.py:3726` |
| `tile_remove` | `cockpit2.py:3788` |
| `rov2_set` | `cockpit2.py:3798` |
| `rov2_acc_add` | `cockpit2.py:3798` |
| `rov2_acc_remove` | `cockpit2.py:3798` |
| `rov2_dom_add` | `cockpit2.py:3798` |
| `rov2_dom_remove` | `cockpit2.py:3798` |
| `backlog_add` | `cockpit2.py:3830` |
| `backlog_update_staat` | `cockpit2.py:3842` |
| `backlog_update_prioriteit` | `cockpit2.py:3854` |
| `person_edit` | `cockpit2.py:3866` |
| `person_remove` | `cockpit2.py:3883` |
| `lk_mute` | `cockpit2.py:3904` |
| `claims_term_add` | `cockpit2.py:4007` |
| `claims_term_retract` | `cockpit2.py:4044` |
| `claims_work_status` | `cockpit2.py:4028` |
| `claims_bewijs_link` | `cockpit2.py:4073` |
| `claims_vondst_whitelist` | `cockpit2.py:4097` |
| `claims_regel_uit_vondst` | `cockpit2.py:4123` |
| `claims_to_board` | `cockpit2.py:4155` |
