...
|---|---|
| `kb_new` | `cockpit2.py:3208` |
| `kb_intake` | `cockpit2.py:3290` |
| `kb_intake_url` | `cockpit2.py:3307` |
| `kb_stage_edit` | `cockpit2.py:3326` |
| `kb_stage_delete` | `cockpit2.py:3333` |
| `kb_stage_merge` | `cockpit2.py:3339` |
| `kb_stage_commit` | `cockpit2.py:3350` |
| `kb_stage_discard` | `cockpit2.py:3364` |
| `kb_atoom_subject` | `cockpit2.py:3434` |
| `kb_atoom_edit` | `cockpit2.py:3370` |
| `kb_atoom_related` | `cockpit2.py:3377` |
| `kb_atoom_reference` | `cockpit2.py:3422` |
| `kb_insight_link` | `cockpit2.py:3389` |
| `kb_insight_unlink` | `cockpit2.py:3396` |
| `kb_meta_start` | `cockpit2.py:3402` |
| `kb_atoom_merge` | `cockpit2.py:3445` |
| `kb_atoom_archive` | `cockpit2.py:3461` |
| `kb_atoom_unarchive` | `cockpit2.py:3470` |
| `kb_atoom_naar_spel` | `cockpit2.py:3476` |
| `kb_spel_start` | `cockpit2.py:3496` |
| `kb_spel_add` | `cockpit2.py:3510` |
| `kb_spel_remove` | `cockpit2.py:3520` |
| `kb_spel_flip` | `cockpit2.py:3527` |
| `kb_spel_finish` | `cockpit2.py:3533` |
| `kb_link` | `cockpit2.py:3217` |
| `kb_unlink` | `cockpit2.py:3231` |
| `kb_annotate` | `cockpit2.py:3242` |
| `kb_evidence` | `cockpit2.py:3248` |
| `kb_discuss` | `cockpit2.py:3269` |
| `kb_reformulate` | `cockpit2.py:3275` |
| `kw_nominate` | `cockpit2.py:3544` |
| `kw_nom_accept` | `cockpit2.py:3555` |
| `kw_nom_reject` | `cockpit2.py:3573` |
| `ws_forbid` | `cockpit2.py:3603` |
| `ws_approve` | `cockpit2.py:3608` |
...
| `claims_term_add` | `cockpit2.py:3102` |
| `claims_work_status` | `cockpit2.py:3125` |
| `claims_to_board` | `cockpit2.py:3144` |
