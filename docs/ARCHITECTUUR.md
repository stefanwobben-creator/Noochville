...
| `kb_atoom_subject` | `cockpit2.py:3263` |
| `kb_atoom_edit` | `cockpit2.py:3199` |
| `kb_atoom_related` | `cockpit2.py:3206` |
| `kb_atoom_reference` | `cockpit2.py:3251` |
| `kb_insight_link` | `cockpit2.py:3218` |
| `kb_insight_unlink` | `cockpit2.py:3225` |
| `kb_meta_start` | `cockpit2.py:3231` |
| `kb_atoom_merge` | `cockpit2.py:3274` |
| `kb_atoom_archive` | `cockpit2.py:3290` |
| `kb_atoom_unarchive` | `cockpit2.py:3299` |
| `kb_atoom_naar_spel` | `cockpit2.py:3305` |
| `kb_spel_start` | `cockpit2.py:3325` |
| `kb_spel_add` | `cockpit2.py:3339` |
| `kb_spel_remove` | `cockpit2.py:3349` |
| `kb_spel_flip` | `cockpit2.py:3356` |
| `kb_spel_finish` | `cockpit2.py:3362` |
...
---
_40 routes · 142 dispatch-acties · 26 stores._
