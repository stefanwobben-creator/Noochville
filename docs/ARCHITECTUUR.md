...
|---|---|
| `ff_beslis` | `cockpit2.py:4958` |
| `ff_cluster` | `cockpit2.py:5086` |
| `ff_promote` | `cockpit2.py:5016` |
| `ff_demote` | `cockpit2.py:5040` |
| `ff_run` | `cockpit2.py:5059` |
| `kb_new` | `cockpit2.py:4338` |
| `kb_intake` | `cockpit2.py:4420` |
| `kb_intake_url` | `cockpit2.py:4437` |
| `kb_stage_edit` | `cockpit2.py:4456` |
| `kb_stage_accept` | `cockpit2.py:4468` |
| `kb_stage_delete` | `cockpit2.py:4487` |
| `kb_stage_merge` | `cockpit2.py:4493` |
| `kb_stage_commit` | `cockpit2.py:4504` |
| `kb_stage_discard` | `cockpit2.py:4524` |
| `kb_atoom_subject` | `cockpit2.py:4762` |
| `kb_atoom_purge` | `cockpit2.py:4746` |
| `tag_voorstel_besluit` | `cockpit2.py:4600` |
| `tag_onderhoud_run` | `cockpit2.py:4733` |
| `copy_stack_inclusie` | `cockpit2.py:4715` |
| `verzoek_besluit` | `cockpit2.py:4619` |
| `kb_blacklist_leeg` | `cockpit2.py:4755` |
| `kb_atoom_edit` | `cockpit2.py:4530` |
| `kb_atoom_related` | `cockpit2.py:4537` |
| `kb_atoom_reference` | `cockpit2.py:4582` |
| `kb_insight_link` | `cockpit2.py:4549` |
| `kb_insight_unlink` | `cockpit2.py:4556` |
| `kb_meta_start` | `cockpit2.py:4562` |
| `kb_atoom_merge` | `cockpit2.py:4773` |
| `kb_atoom_archive` | `cockpit2.py:4794` |
| `kb_atoom_unarchive` | `cockpit2.py:4803` |
| `kb_atoom_naar_spel` | `cockpit2.py:4809` |
| `kb_spel_start` | `cockpit2.py:4830` |
| `kb_spel_add` | `cockpit2.py:4844` |
| `kb_spel_remove` | `cockpit2.py:4854` |
| `kb_spel_flip` | `cockpit2.py:4861` |
| `kb_spel_finish` | `cockpit2.py:4867` |
| `kb_link` | `cockpit2.py:4347` |
| `kb_unlink` | `cockpit2.py:4361` |
| `kb_annotate` | `cockpit2.py:4372` |
| `kb_evidence` | `cockpit2.py:4378` |
| `kb_discuss` | `cockpit2.py:4399` |
| `kb_reformulate` | `cockpit2.py:4405` |
| `kw_nominate` | `cockpit2.py:4878` |
| `kw_nom_accept` | `cockpit2.py:4889` |
| `kw_nom_reject` | `cockpit2.py:4907` |
| `ws_forbid` | `cockpit2.py:4937` |
| `ws_approve` | `cockpit2.py:4942` |
...
| `wo_checkout` | `cockpit2.py:3558` |
| `noochie_send` | `cockpit2.py:3573` |
| `noochie_reset` | `cockpit2.py:3599` |
| `noochie_ctx` | `cockpit2.py:3606` |
| `cl_add` | `cockpit2.py:3613` |
| `cl_report` | `cockpit2.py:3631` |
| `cl_remove` | `cockpit2.py:3646` |
| `m_add_kpi` | `cockpit2.py:3656` |
| `m_add_from_def` | `cockpit2.py:3688` |
| `def_add` | `cockpit2.py:3703` |
| `catalog_publish` | `cockpit2.py:3725` |
| `def_amend` | `cockpit2.py:3751` |
| `m_add_link` | `cockpit2.py:3793` |
| `m_sample` | `cockpit2.py:3804` |
| `m_remove` | `cockpit2.py:3814` |
| `m_pin` | `cockpit2.py:3824` |
| `m_unpin` | `cockpit2.py:3835` |
| `tile_add` | `cockpit2.py:3873` |
| `indicator_activate` | `cockpit2.py:3845` |
| `tile_remove` | `cockpit2.py:3907` |
| `rov2_set` | `cockpit2.py:3917` |
| `rov2_acc_add` | `cockpit2.py:3917` |
| `rov2_acc_remove` | `cockpit2.py:3917` |
| `rov2_dom_add` | `cockpit2.py:3917` |
| `rov2_dom_remove` | `cockpit2.py:3917` |
| `backlog_add` | `cockpit2.py:3949` |
| `backlog_update_staat` | `cockpit2.py:3961` |
| `backlog_update_prioriteit` | `cockpit2.py:3973` |
| `person_edit` | `cockpit2.py:3985` |
| `person_remove` | `cockpit2.py:4002` |
| `lk_mute` | `cockpit2.py:4023` |
| `claims_term_add` | `cockpit2.py:4126` |
| `claims_term_retract` | `cockpit2.py:4163` |
| `claims_work_status` | `cockpit2.py:4147` |
| `claims_bewijs_link` | `cockpit2.py:4192` |
| `claims_vondst_whitelist` | `cockpit2.py:4216` |
| `claims_regel_uit_vondst` | `cockpit2.py:4242` |
| `claims_to_board` | `cockpit2.py:4274` |
