...
|---|---|
| `ff_beslis` | `cockpit2.py:5230` |
| `ff_cluster` | `cockpit2.py:5358` |
| `ff_promote` | `cockpit2.py:5288` |
| `ff_demote` | `cockpit2.py:5312` |
| `ff_run` | `cockpit2.py:5331` |
| `kb_new` | `cockpit2.py:4593` |
| `kb_intake` | `cockpit2.py:4675` |
| `kb_intake_url` | `cockpit2.py:4692` |
| `kb_stage_edit` | `cockpit2.py:4711` |
| `kb_stage_accept` | `cockpit2.py:4723` |
| `kb_stage_delete` | `cockpit2.py:4742` |
| `kb_stage_merge` | `cockpit2.py:4748` |
| `kb_stage_commit` | `cockpit2.py:4759` |
| `kb_stage_discard` | `cockpit2.py:4779` |
| `kb_atoom_subject` | `cockpit2.py:5034` |
| `kb_atoom_purge` | `cockpit2.py:5018` |
| `tag_voorstel_besluit` | `cockpit2.py:4855` |
| `tag_onderhoud_run` | `cockpit2.py:5005` |
| `copy_stack_inclusie` | `cockpit2.py:4987` |
| `verzoek_besluit` | `cockpit2.py:4874` |
| `kb_blacklist_leeg` | `cockpit2.py:5027` |
| `kb_atoom_edit` | `cockpit2.py:4785` |
| `kb_atoom_related` | `cockpit2.py:4792` |
| `kb_atoom_reference` | `cockpit2.py:4837` |
| `kb_insight_link` | `cockpit2.py:4804` |
| `kb_insight_unlink` | `cockpit2.py:4811` |
| `kb_meta_start` | `cockpit2.py:4817` |
| `kb_atoom_merge` | `cockpit2.py:5045` |
| `kb_atoom_archive` | `cockpit2.py:5066` |
| `kb_atoom_unarchive` | `cockpit2.py:5075` |
| `kb_atoom_naar_spel` | `cockpit2.py:5081` |
| `kb_spel_start` | `cockpit2.py:5102` |
| `kb_spel_add` | `cockpit2.py:5116` |
| `kb_spel_remove` | `cockpit2.py:5126` |
| `kb_spel_flip` | `cockpit2.py:5133` |
| `kb_spel_finish` | `cockpit2.py:5139` |
| `kb_link` | `cockpit2.py:4602` |
| `kb_unlink` | `cockpit2.py:4616` |
| `kb_annotate` | `cockpit2.py:4627` |
| `kb_evidence` | `cockpit2.py:4633` |
| `kb_discuss` | `cockpit2.py:4654` |
| `kb_reformulate` | `cockpit2.py:4660` |
| `kw_nominate` | `cockpit2.py:5150` |
| `kw_nom_accept` | `cockpit2.py:5161` |
| `kw_nom_reject` | `cockpit2.py:5179` |
| `ws_forbid` | `cockpit2.py:5209` |
| `ws_approve` | `cockpit2.py:5214` |
...
| `wall_outcome` | `cockpit2.py:3371` |
| `notif_read` | `cockpit2.py:3467` |
| `notif_processed` | `cockpit2.py:3472` |
| `notif_outcome` | `cockpit2.py:3691` |
| `notif_klaar` | `cockpit2.py:3638` |
| `notif_delete` | `cockpit2.py:3477` |
| `notif_add` | `cockpit2.py:3589` |
| `notif_archive` | `cockpit2.py:3808` |
| `metrics2_fav` | `cockpit2.py:3483` |
| `metrics2_unfav` | `cockpit2.py:3493` |
| `metrics2_form` | `cockpit2.py:3498` |
| `metrics2_dim` | `cockpit2.py:3504` |
| `metrics2_compare` | `cockpit2.py:3511` |
| `metrics2_formula` | `cockpit2.py:3574` |
| `source_activate` | `cockpit2.py:3557` |
| `source_deactivate` | `cockpit2.py:3566` |
| `link_pursue` | `cockpit2.py:3538` |
| `link_ignore` | `cockpit2.py:3548` |
| `acc_check` | `cockpit2.py:3519` |
...
| `wo_checkout` | `cockpit2.py:3813` |
| `noochie_send` | `cockpit2.py:3828` |
| `noochie_reset` | `cockpit2.py:3854` |
| `noochie_ctx` | `cockpit2.py:3861` |
| `cl_add` | `cockpit2.py:3868` |
| `cl_report` | `cockpit2.py:3886` |
| `cl_remove` | `cockpit2.py:3901` |
| `m_add_kpi` | `cockpit2.py:3911` |
| `m_add_from_def` | `cockpit2.py:3943` |
| `def_add` | `cockpit2.py:3958` |
| `catalog_publish` | `cockpit2.py:3980` |
| `def_amend` | `cockpit2.py:4006` |
| `m_add_link` | `cockpit2.py:4048` |
| `m_sample` | `cockpit2.py:4059` |
| `m_remove` | `cockpit2.py:4069` |
| `m_pin` | `cockpit2.py:4079` |
| `m_unpin` | `cockpit2.py:4090` |
| `tile_add` | `cockpit2.py:4128` |
| `indicator_activate` | `cockpit2.py:4100` |
| `tile_remove` | `cockpit2.py:4162` |
| `rov2_set` | `cockpit2.py:4172` |
| `rov2_acc_add` | `cockpit2.py:4172` |
| `rov2_acc_remove` | `cockpit2.py:4172` |
| `rov2_dom_add` | `cockpit2.py:4172` |
| `rov2_dom_remove` | `cockpit2.py:4172` |
| `backlog_add` | `cockpit2.py:4204` |
| `backlog_update_staat` | `cockpit2.py:4216` |
| `backlog_update_prioriteit` | `cockpit2.py:4228` |
| `person_edit` | `cockpit2.py:4240` |
| `person_remove` | `cockpit2.py:4257` |
| `lk_mute` | `cockpit2.py:4278` |
| `claims_term_add` | `cockpit2.py:4381` |
| `claims_term_retract` | `cockpit2.py:4418` |
| `claims_work_status` | `cockpit2.py:4402` |
| `claims_bewijs_link` | `cockpit2.py:4447` |
| `claims_vondst_whitelist` | `cockpit2.py:4471` |
| `claims_regel_uit_vondst` | `cockpit2.py:4497` |
| `claims_to_board` | `cockpit2.py:4529` |
