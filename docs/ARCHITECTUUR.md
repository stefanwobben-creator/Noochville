...
|---|---|
| `ff_beslis` | `cockpit2.py:5122` |
| `ff_cluster` | `cockpit2.py:5250` |
| `ff_promote` | `cockpit2.py:5180` |
| `ff_demote` | `cockpit2.py:5204` |
| `ff_run` | `cockpit2.py:5223` |
...
| `kb_atoom_subject` | `cockpit2.py:4926` |
| `kb_atoom_purge` | `cockpit2.py:4910` |
| `tag_voorstel_besluit` | `cockpit2.py:4752` |
| `tag_onderhoud_run` | `cockpit2.py:4897` |
| `copy_stack_inclusie` | `cockpit2.py:4879` |
| `verzoek_besluit` | `cockpit2.py:4771` |
| `kb_blacklist_leeg` | `cockpit2.py:4919` |
...
| `kb_atoom_merge` | `cockpit2.py:4937` |
| `kb_atoom_archive` | `cockpit2.py:4958` |
| `kb_atoom_unarchive` | `cockpit2.py:4967` |
| `kb_atoom_naar_spel` | `cockpit2.py:4973` |
| `kb_spel_start` | `cockpit2.py:4994` |
| `kb_spel_add` | `cockpit2.py:5008` |
| `kb_spel_remove` | `cockpit2.py:5018` |
| `kb_spel_flip` | `cockpit2.py:5025` |
| `kb_spel_finish` | `cockpit2.py:5031` |
...
| `kw_nominate` | `cockpit2.py:5042` |
| `kw_nom_accept` | `cockpit2.py:5053` |
| `kw_nom_reject` | `cockpit2.py:5071` |
| `ws_forbid` | `cockpit2.py:5101` |
| `ws_approve` | `cockpit2.py:5106` |
