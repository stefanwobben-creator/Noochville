...
|---|---|
| `ff_beslis` | `cockpit2.py:5079` |
| `ff_cluster` | `cockpit2.py:5207` |
| `ff_promote` | `cockpit2.py:5137` |
| `ff_demote` | `cockpit2.py:5161` |
| `ff_run` | `cockpit2.py:5180` |
| `kb_new` | `cockpit2.py:4447` |
| `kb_intake` | `cockpit2.py:4529` |
| `kb_intake_url` | `cockpit2.py:4546` |
| `kb_stage_edit` | `cockpit2.py:4565` |
| `kb_stage_accept` | `cockpit2.py:4577` |
| `kb_stage_delete` | `cockpit2.py:4596` |
| `kb_stage_merge` | `cockpit2.py:4602` |
| `kb_stage_commit` | `cockpit2.py:4613` |
| `kb_stage_discard` | `cockpit2.py:4633` |
| `kb_atoom_subject` | `cockpit2.py:4883` |
| `kb_atoom_purge` | `cockpit2.py:4867` |
| `tag_voorstel_besluit` | `cockpit2.py:4709` |
| `tag_onderhoud_run` | `cockpit2.py:4854` |
| `copy_stack_inclusie` | `cockpit2.py:4836` |
| `verzoek_besluit` | `cockpit2.py:4728` |
| `kb_blacklist_leeg` | `cockpit2.py:4876` |
| `kb_atoom_edit` | `cockpit2.py:4639` |
| `kb_atoom_related` | `cockpit2.py:4646` |
| `kb_atoom_reference` | `cockpit2.py:4691` |
| `kb_insight_link` | `cockpit2.py:4658` |
| `kb_insight_unlink` | `cockpit2.py:4665` |
| `kb_meta_start` | `cockpit2.py:4671` |
| `kb_atoom_merge` | `cockpit2.py:4894` |
| `kb_atoom_archive` | `cockpit2.py:4915` |
| `kb_atoom_unarchive` | `cockpit2.py:4924` |
| `kb_atoom_naar_spel` | `cockpit2.py:4930` |
| `kb_spel_start` | `cockpit2.py:4951` |
| `kb_spel_add` | `cockpit2.py:4965` |
| `kb_spel_remove` | `cockpit2.py:4975` |
| `kb_spel_flip` | `cockpit2.py:4982` |
| `kb_spel_finish` | `cockpit2.py:4988` |
| `kb_link` | `cockpit2.py:4456` |
| `kb_unlink` | `cockpit2.py:4470` |
| `kb_annotate` | `cockpit2.py:4481` |
| `kb_evidence` | `cockpit2.py:4487` |
| `kb_discuss` | `cockpit2.py:4508` |
| `kb_reformulate` | `cockpit2.py:4514` |
| `kw_nominate` | `cockpit2.py:4999` |
| `kw_nom_accept` | `cockpit2.py:5010` |
| `kw_nom_reject` | `cockpit2.py:5028` |
| `ws_forbid` | `cockpit2.py:5058` |
| `ws_approve` | `cockpit2.py:5063` |
...
| `notif_outcome` | `cockpit2.py:3571` |
| `notif_klaar` | `cockpit2.py:3534` |
| `notif_delete` | `cockpit2.py:3373` |
| `notif_add` | `cockpit2.py:3485` |
| `notif_archive` | `cockpit2.py:3662` |
...
| `wo_checkout` | `cockpit2.py:3667` |
| `noochie_send` | `cockpit2.py:3682` |
| `noochie_reset` | `cockpit2.py:3708` |
| `noochie_ctx` | `cockpit2.py:3715` |
| `cl_add` | `cockpit2.py:3722` |
| `cl_report` | `cockpit2.py:3740` |
| `cl_remove` | `cockpit2.py:3755` |
| `m_add_kpi` | `cockpit2.py:3765` |
| `m_add_from_def` | `cockpit2.py:3797` |
| `def_add` | `cockpit2.py:3812` |
| `catalog_publish` | `cockpit2.py:3834` |
| `def_amend` | `cockpit2.py:3860` |
| `m_add_link` | `cockpit2.py:3902` |
| `m_sample` | `cockpit2.py:3913` |
| `m_remove` | `cockpit2.py:3923` |
| `m_pin` | `cockpit2.py:3933` |
| `m_unpin` | `cockpit2.py:3944` |
| `tile_add` | `cockpit2.py:3982` |
| `indicator_activate` | `cockpit2.py:3954` |
| `tile_remove` | `cockpit2.py:4016` |
| `rov2_set` | `cockpit2.py:4026` |
| `rov2_acc_add` | `cockpit2.py:4026` |
| `rov2_acc_remove` | `cockpit2.py:4026` |
| `rov2_dom_add` | `cockpit2.py:4026` |
| `rov2_dom_remove` | `cockpit2.py:4026` |
| `backlog_add` | `cockpit2.py:4058` |
| `backlog_update_staat` | `cockpit2.py:4070` |
| `backlog_update_prioriteit` | `cockpit2.py:4082` |
| `person_edit` | `cockpit2.py:4094` |
| `person_remove` | `cockpit2.py:4111` |
| `lk_mute` | `cockpit2.py:4132` |
| `claims_term_add` | `cockpit2.py:4235` |
| `claims_term_retract` | `cockpit2.py:4272` |
| `claims_work_status` | `cockpit2.py:4256` |
| `claims_bewijs_link` | `cockpit2.py:4301` |
| `claims_vondst_whitelist` | `cockpit2.py:4325` |
| `claims_regel_uit_vondst` | `cockpit2.py:4351` |
| `claims_to_board` | `cockpit2.py:4383` |
