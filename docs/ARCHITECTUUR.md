...
|---|---|
| `ff_beslis` | `cockpit2.py:5091` |
| `ff_cluster` | `cockpit2.py:5219` |
| `ff_promote` | `cockpit2.py:5149` |
| `ff_demote` | `cockpit2.py:5173` |
| `ff_run` | `cockpit2.py:5192` |
| `kb_new` | `cockpit2.py:4459` |
| `kb_intake` | `cockpit2.py:4541` |
| `kb_intake_url` | `cockpit2.py:4558` |
| `kb_stage_edit` | `cockpit2.py:4577` |
| `kb_stage_accept` | `cockpit2.py:4589` |
| `kb_stage_delete` | `cockpit2.py:4608` |
| `kb_stage_merge` | `cockpit2.py:4614` |
| `kb_stage_commit` | `cockpit2.py:4625` |
| `kb_stage_discard` | `cockpit2.py:4645` |
| `kb_atoom_subject` | `cockpit2.py:4895` |
| `kb_atoom_purge` | `cockpit2.py:4879` |
| `tag_voorstel_besluit` | `cockpit2.py:4721` |
| `tag_onderhoud_run` | `cockpit2.py:4866` |
| `copy_stack_inclusie` | `cockpit2.py:4848` |
| `verzoek_besluit` | `cockpit2.py:4740` |
| `kb_blacklist_leeg` | `cockpit2.py:4888` |
| `kb_atoom_edit` | `cockpit2.py:4651` |
| `kb_atoom_related` | `cockpit2.py:4658` |
| `kb_atoom_reference` | `cockpit2.py:4703` |
| `kb_insight_link` | `cockpit2.py:4670` |
| `kb_insight_unlink` | `cockpit2.py:4677` |
| `kb_meta_start` | `cockpit2.py:4683` |
| `kb_atoom_merge` | `cockpit2.py:4906` |
| `kb_atoom_archive` | `cockpit2.py:4927` |
| `kb_atoom_unarchive` | `cockpit2.py:4936` |
| `kb_atoom_naar_spel` | `cockpit2.py:4942` |
| `kb_spel_start` | `cockpit2.py:4963` |
| `kb_spel_add` | `cockpit2.py:4977` |
| `kb_spel_remove` | `cockpit2.py:4987` |
| `kb_spel_flip` | `cockpit2.py:4994` |
| `kb_spel_finish` | `cockpit2.py:5000` |
| `kb_link` | `cockpit2.py:4468` |
| `kb_unlink` | `cockpit2.py:4482` |
| `kb_annotate` | `cockpit2.py:4493` |
| `kb_evidence` | `cockpit2.py:4499` |
| `kb_discuss` | `cockpit2.py:4520` |
| `kb_reformulate` | `cockpit2.py:4526` |
| `kw_nominate` | `cockpit2.py:5011` |
| `kw_nom_accept` | `cockpit2.py:5022` |
| `kw_nom_reject` | `cockpit2.py:5040` |
| `ws_forbid` | `cockpit2.py:5070` |
| `ws_approve` | `cockpit2.py:5075` |
...
| `wall_outcome` | `cockpit2.py:3279` |
| `notif_read` | `cockpit2.py:3375` |
| `notif_processed` | `cockpit2.py:3380` |
| `notif_outcome` | `cockpit2.py:3583` |
| `notif_klaar` | `cockpit2.py:3546` |
| `notif_delete` | `cockpit2.py:3385` |
| `notif_add` | `cockpit2.py:3497` |
| `notif_archive` | `cockpit2.py:3674` |
| `metrics2_fav` | `cockpit2.py:3391` |
| `metrics2_unfav` | `cockpit2.py:3401` |
| `metrics2_form` | `cockpit2.py:3406` |
| `metrics2_dim` | `cockpit2.py:3412` |
| `metrics2_compare` | `cockpit2.py:3419` |
| `metrics2_formula` | `cockpit2.py:3482` |
| `source_activate` | `cockpit2.py:3465` |
| `source_deactivate` | `cockpit2.py:3474` |
| `link_pursue` | `cockpit2.py:3446` |
| `link_ignore` | `cockpit2.py:3456` |
| `acc_check` | `cockpit2.py:3427` |
...
| `wo_checkout` | `cockpit2.py:3679` |
| `noochie_send` | `cockpit2.py:3694` |
| `noochie_reset` | `cockpit2.py:3720` |
| `noochie_ctx` | `cockpit2.py:3727` |
| `cl_add` | `cockpit2.py:3734` |
| `cl_report` | `cockpit2.py:3752` |
| `cl_remove` | `cockpit2.py:3767` |
| `m_add_kpi` | `cockpit2.py:3777` |
| `m_add_from_def` | `cockpit2.py:3809` |
| `def_add` | `cockpit2.py:3824` |
| `catalog_publish` | `cockpit2.py:3846` |
| `def_amend` | `cockpit2.py:3872` |
| `m_add_link` | `cockpit2.py:3914` |
| `m_sample` | `cockpit2.py:3925` |
| `m_remove` | `cockpit2.py:3935` |
| `m_pin` | `cockpit2.py:3945` |
| `m_unpin` | `cockpit2.py:3956` |
| `tile_add` | `cockpit2.py:3994` |
| `indicator_activate` | `cockpit2.py:3966` |
| `tile_remove` | `cockpit2.py:4028` |
| `rov2_set` | `cockpit2.py:4038` |
| `rov2_acc_add` | `cockpit2.py:4038` |
| `rov2_acc_remove` | `cockpit2.py:4038` |
| `rov2_dom_add` | `cockpit2.py:4038` |
| `rov2_dom_remove` | `cockpit2.py:4038` |
| `backlog_add` | `cockpit2.py:4070` |
| `backlog_update_staat` | `cockpit2.py:4082` |
| `backlog_update_prioriteit` | `cockpit2.py:4094` |
| `person_edit` | `cockpit2.py:4106` |
| `person_remove` | `cockpit2.py:4123` |
| `lk_mute` | `cockpit2.py:4144` |
| `claims_term_add` | `cockpit2.py:4247` |
| `claims_term_retract` | `cockpit2.py:4284` |
| `claims_work_status` | `cockpit2.py:4268` |
| `claims_bewijs_link` | `cockpit2.py:4313` |
| `claims_vondst_whitelist` | `cockpit2.py:4337` |
| `claims_regel_uit_vondst` | `cockpit2.py:4363` |
| `claims_to_board` | `cockpit2.py:4395` |
