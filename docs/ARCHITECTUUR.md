...
|---|---|
| `ff_beslis` | `cockpit2.py:5201` |
| `ff_cluster` | `cockpit2.py:5329` |
| `ff_promote` | `cockpit2.py:5259` |
| `ff_demote` | `cockpit2.py:5283` |
| `ff_run` | `cockpit2.py:5302` |
| `kb_new` | `cockpit2.py:4564` |
| `kb_intake` | `cockpit2.py:4646` |
| `kb_intake_url` | `cockpit2.py:4663` |
| `kb_stage_edit` | `cockpit2.py:4682` |
| `kb_stage_accept` | `cockpit2.py:4694` |
| `kb_stage_delete` | `cockpit2.py:4713` |
| `kb_stage_merge` | `cockpit2.py:4719` |
| `kb_stage_commit` | `cockpit2.py:4730` |
| `kb_stage_discard` | `cockpit2.py:4750` |
| `kb_atoom_subject` | `cockpit2.py:5005` |
| `kb_atoom_purge` | `cockpit2.py:4989` |
| `tag_voorstel_besluit` | `cockpit2.py:4826` |
| `tag_onderhoud_run` | `cockpit2.py:4976` |
| `copy_stack_inclusie` | `cockpit2.py:4958` |
| `verzoek_besluit` | `cockpit2.py:4845` |
| `kb_blacklist_leeg` | `cockpit2.py:4998` |
| `kb_atoom_edit` | `cockpit2.py:4756` |
| `kb_atoom_related` | `cockpit2.py:4763` |
| `kb_atoom_reference` | `cockpit2.py:4808` |
| `kb_insight_link` | `cockpit2.py:4775` |
| `kb_insight_unlink` | `cockpit2.py:4782` |
| `kb_meta_start` | `cockpit2.py:4788` |
| `kb_atoom_merge` | `cockpit2.py:5016` |
| `kb_atoom_archive` | `cockpit2.py:5037` |
| `kb_atoom_unarchive` | `cockpit2.py:5046` |
| `kb_atoom_naar_spel` | `cockpit2.py:5052` |
| `kb_spel_start` | `cockpit2.py:5073` |
| `kb_spel_add` | `cockpit2.py:5087` |
| `kb_spel_remove` | `cockpit2.py:5097` |
| `kb_spel_flip` | `cockpit2.py:5104` |
| `kb_spel_finish` | `cockpit2.py:5110` |
| `kb_link` | `cockpit2.py:4573` |
| `kb_unlink` | `cockpit2.py:4587` |
| `kb_annotate` | `cockpit2.py:4598` |
| `kb_evidence` | `cockpit2.py:4604` |
| `kb_discuss` | `cockpit2.py:4625` |
| `kb_reformulate` | `cockpit2.py:4631` |
| `kw_nominate` | `cockpit2.py:5121` |
| `kw_nom_accept` | `cockpit2.py:5132` |
| `kw_nom_reject` | `cockpit2.py:5150` |
| `ws_forbid` | `cockpit2.py:5180` |
| `ws_approve` | `cockpit2.py:5185` |
...
| `wo_checkout` | `cockpit2.py:3784` |
| `noochie_send` | `cockpit2.py:3799` |
| `noochie_reset` | `cockpit2.py:3825` |
| `noochie_ctx` | `cockpit2.py:3832` |
| `cl_add` | `cockpit2.py:3839` |
| `cl_report` | `cockpit2.py:3857` |
| `cl_remove` | `cockpit2.py:3872` |
| `m_add_kpi` | `cockpit2.py:3882` |
| `m_add_from_def` | `cockpit2.py:3914` |
| `def_add` | `cockpit2.py:3929` |
| `catalog_publish` | `cockpit2.py:3951` |
| `def_amend` | `cockpit2.py:3977` |
| `m_add_link` | `cockpit2.py:4019` |
| `m_sample` | `cockpit2.py:4030` |
| `m_remove` | `cockpit2.py:4040` |
| `m_pin` | `cockpit2.py:4050` |
| `m_unpin` | `cockpit2.py:4061` |
| `tile_add` | `cockpit2.py:4099` |
| `indicator_activate` | `cockpit2.py:4071` |
| `tile_remove` | `cockpit2.py:4133` |
| `rov2_set` | `cockpit2.py:4143` |
| `rov2_acc_add` | `cockpit2.py:4143` |
| `rov2_acc_remove` | `cockpit2.py:4143` |
| `rov2_dom_add` | `cockpit2.py:4143` |
| `rov2_dom_remove` | `cockpit2.py:4143` |
| `backlog_add` | `cockpit2.py:4175` |
| `backlog_update_staat` | `cockpit2.py:4187` |
| `backlog_update_prioriteit` | `cockpit2.py:4199` |
| `person_edit` | `cockpit2.py:4211` |
| `person_remove` | `cockpit2.py:4228` |
| `lk_mute` | `cockpit2.py:4249` |
| `claims_term_add` | `cockpit2.py:4352` |
| `claims_term_retract` | `cockpit2.py:4389` |
| `claims_work_status` | `cockpit2.py:4373` |
| `claims_bewijs_link` | `cockpit2.py:4418` |
| `claims_vondst_whitelist` | `cockpit2.py:4442` |
| `claims_regel_uit_vondst` | `cockpit2.py:4468` |
| `claims_to_board` | `cockpit2.py:4500` |
