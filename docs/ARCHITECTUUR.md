...
|---|---|
| `ff_beslis` | `cockpit2.py:4873` |
| `ff_cluster` | `cockpit2.py:5001` |
| `ff_promote` | `cockpit2.py:4931` |
| `ff_demote` | `cockpit2.py:4955` |
| `ff_run` | `cockpit2.py:4974` |
| `kb_new` | `cockpit2.py:4253` |
| `kb_intake` | `cockpit2.py:4335` |
| `kb_intake_url` | `cockpit2.py:4352` |
| `kb_stage_edit` | `cockpit2.py:4371` |
| `kb_stage_accept` | `cockpit2.py:4383` |
| `kb_stage_delete` | `cockpit2.py:4402` |
| `kb_stage_merge` | `cockpit2.py:4408` |
| `kb_stage_commit` | `cockpit2.py:4419` |
| `kb_stage_discard` | `cockpit2.py:4439` |
| `kb_atoom_subject` | `cockpit2.py:4677` |
| `kb_atoom_purge` | `cockpit2.py:4661` |
| `tag_voorstel_besluit` | `cockpit2.py:4515` |
| `tag_onderhoud_run` | `cockpit2.py:4648` |
| `copy_stack_inclusie` | `cockpit2.py:4630` |
| `verzoek_besluit` | `cockpit2.py:4534` |
| `kb_blacklist_leeg` | `cockpit2.py:4670` |
| `kb_atoom_edit` | `cockpit2.py:4445` |
| `kb_atoom_related` | `cockpit2.py:4452` |
| `kb_atoom_reference` | `cockpit2.py:4497` |
| `kb_insight_link` | `cockpit2.py:4464` |
| `kb_insight_unlink` | `cockpit2.py:4471` |
| `kb_meta_start` | `cockpit2.py:4477` |
| `kb_atoom_merge` | `cockpit2.py:4688` |
| `kb_atoom_archive` | `cockpit2.py:4709` |
| `kb_atoom_unarchive` | `cockpit2.py:4718` |
| `kb_atoom_naar_spel` | `cockpit2.py:4724` |
| `kb_spel_start` | `cockpit2.py:4745` |
| `kb_spel_add` | `cockpit2.py:4759` |
| `kb_spel_remove` | `cockpit2.py:4769` |
| `kb_spel_flip` | `cockpit2.py:4776` |
| `kb_spel_finish` | `cockpit2.py:4782` |
| `kb_link` | `cockpit2.py:4262` |
| `kb_unlink` | `cockpit2.py:4276` |
| `kb_annotate` | `cockpit2.py:4287` |
| `kb_evidence` | `cockpit2.py:4293` |
| `kb_discuss` | `cockpit2.py:4314` |
| `kb_reformulate` | `cockpit2.py:4320` |
| `kw_nominate` | `cockpit2.py:4793` |
| `kw_nom_accept` | `cockpit2.py:4804` |
| `kw_nom_reject` | `cockpit2.py:4822` |
| `ws_forbid` | `cockpit2.py:4852` |
| `ws_approve` | `cockpit2.py:4857` |
...
| `noochie_send` | `cockpit2.py:3488` |
| `noochie_reset` | `cockpit2.py:3514` |
| `noochie_ctx` | `cockpit2.py:3521` |
| `cl_add` | `cockpit2.py:3528` |
| `cl_report` | `cockpit2.py:3546` |
| `cl_remove` | `cockpit2.py:3561` |
| `m_add_kpi` | `cockpit2.py:3571` |
| `m_add_from_def` | `cockpit2.py:3603` |
| `def_add` | `cockpit2.py:3618` |
| `catalog_publish` | `cockpit2.py:3640` |
| `def_amend` | `cockpit2.py:3666` |
| `m_add_link` | `cockpit2.py:3708` |
| `m_sample` | `cockpit2.py:3719` |
| `m_remove` | `cockpit2.py:3729` |
| `m_pin` | `cockpit2.py:3739` |
| `m_unpin` | `cockpit2.py:3750` |
| `tile_add` | `cockpit2.py:3788` |
| `indicator_activate` | `cockpit2.py:3760` |
| `tile_remove` | `cockpit2.py:3822` |
| `rov2_set` | `cockpit2.py:3832` |
| `rov2_acc_add` | `cockpit2.py:3832` |
| `rov2_acc_remove` | `cockpit2.py:3832` |
| `rov2_dom_add` | `cockpit2.py:3832` |
| `rov2_dom_remove` | `cockpit2.py:3832` |
| `backlog_add` | `cockpit2.py:3864` |
| `backlog_update_staat` | `cockpit2.py:3876` |
| `backlog_update_prioriteit` | `cockpit2.py:3888` |
| `person_edit` | `cockpit2.py:3900` |
| `person_remove` | `cockpit2.py:3917` |
| `lk_mute` | `cockpit2.py:3938` |
| `claims_term_add` | `cockpit2.py:4041` |
| `claims_term_retract` | `cockpit2.py:4078` |
| `claims_work_status` | `cockpit2.py:4062` |
| `claims_bewijs_link` | `cockpit2.py:4107` |
| `claims_vondst_whitelist` | `cockpit2.py:4131` |
| `claims_regel_uit_vondst` | `cockpit2.py:4157` |
| `claims_to_board` | `cockpit2.py:4189` |
