...
KADER_VOORSTEL = (
    ...
    "De sectie 'GEGEVEN IN DE OPDRACHT' in de onderbouwing bevat wat de taak zelf vaststelt: welke "
    "claim onderzocht wordt, op welke pagina, met welk doel. Verwijst het voorstel daarnaar, dan is "
    "dat GEGROND — de opdracht is een feit.\n"
    "Maar dat maakt BEWERINGEN OVER die gegevens niet gegrond. 'De claim staat op de FAQ-pagina' is "
    "gegrond als de opdracht die pagina noemt; 'de FAQ-pagina zegt X' heeft een deliverable nodig "
    "die dat heeft opgehaald. Context, geen vrijbrief.\n"
